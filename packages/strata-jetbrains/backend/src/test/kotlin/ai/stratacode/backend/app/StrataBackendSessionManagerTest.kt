...
class StrataBackendSessionManagerTest {
    ...
    private fun setup(): StrataBackendAppService {
        return StrataBackendAppService.create(scope, FakeCliServer(mock), log)
    }

    private suspend fun ready(app: StrataBackendAppService) {
        app.connect()
        withTimeout(10_000) {
