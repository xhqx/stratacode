...
import ai.stratacode.jetbrains.api.model.AppSkills200ResponseInner
import ai.stratacode.jetbrains.api.model.Command
import ai.stratacode.jetbrains.api.model.ProviderList200Response
...
class ProjectModelSerializationTest {
    ...
    fun `provider list with isFree and status`() {
        ...
        assertEquals(
            ai.stratacode.jetbrains.api.model.Model.Status.BETA,
            model.status,
        )
    }
