 ...
 */
@Rpc
interface StrataSessionRpcApi : RemoteApi<Unit> {
    companion object {
        suspend fun getInstance(): StrataSessionRpcApi {
            return RemoteApiProviderService.resolve(remoteApiDescriptor<StrataSessionRpcApi>())
        }
    }
