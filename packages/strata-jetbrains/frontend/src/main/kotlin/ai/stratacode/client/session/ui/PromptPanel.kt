...
class PromptPanel(
    ...
    companion object {
        private val LOG = StrataLog.create(PromptPanel::class.java)
    ...
    private val editor = EditorTextField(project, PlainTextFileType.INSTANCE).apply {
        setPlaceholder(StrataBundle.message("prompt.placeholder"))
    ...
    private val button = JButton(SEND_ICON).apply {
        ...
        toolTipText = StrataBundle.message("prompt.button.send")
        isEnabled = false
    ...
    fun setBusy(value: Boolean) {
        ...
        button.toolTipText = if (value) StrataBundle.message("prompt.button.stop") else StrataBundle.message("prompt.button.send")
    }
