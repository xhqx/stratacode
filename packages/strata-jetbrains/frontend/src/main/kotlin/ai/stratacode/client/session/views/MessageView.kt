 ...
 * driven by [ai.stratacode.client.session.ui.SessionLayout] so that each
 ...
 */
class MessageView(val msg: Message) : ai.stratacode.client.session.ui.SessionLayoutPanel() {
