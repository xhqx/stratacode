...
import ai.stratacode.client.session.views.MessageView
import ai.stratacode.client.session.views.TurnView
...
class SessionPanel(
    ...
    private fun onTurnAdded(turn: ai.stratacode.client.session.model.Turn) {
    ...
    private fun onTurnUpdated(turn: ai.stratacode.client.session.model.Turn) {
