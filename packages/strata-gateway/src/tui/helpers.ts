/**
 * TUI-specific helper functions for Strata Gateway integration
 *
...
import type { StratacodeProfile, StratacodeBalance, Organization } from "../types.js"
...
export function formatProfileInfo(
  ...
  const usageUrl = currentOrgId
    ? `https://app.strata.ai/organizations/${currentOrgId}/usage-details`
