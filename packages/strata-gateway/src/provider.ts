...
import type { StrataProvider, StrataProviderOptions } from "./types.js"
...
/**
 * Create a StrataCode provider instance
 *
 * This provider wraps the OpenRouter SDK with StrataCode-specific configuration
 * including custom authentication, headers, and base URL.
 *
 * @example
 * ```typescript
 * const provider = createStrata({
 *   stratacodeToken: "your-token-here",
 ...
 * ```
 */
export function createStrata(options: StrataProviderOptions = {}): StrataProvider {
