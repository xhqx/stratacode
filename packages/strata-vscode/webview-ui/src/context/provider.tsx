...
import type { ProviderAuthMethod } from "@stratacode/sdk/v2/client"
import { flattenModels, findModel as _findModel, isModelValid as isValid } from "./provider-utils"
import { STRATA_AUTO } from "../../../src/shared/provider-model"
...
export const ProviderProvider: ParentComponent = (props) => {
  ...
  const [defaultSelection, setDefaultSelection] = createSignal<ModelSelection>(STRATA_AUTO)
