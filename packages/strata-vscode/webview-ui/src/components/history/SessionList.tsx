 ...
 * Uses strata-ui List component for keyboard navigation and accessibility.
...
import { InlineInput } from "@stratacode/strata-ui/inline-input"
...
const SessionList: Component<SessionListProps> = (props) => {
  ...
  onMount(() => {
    console.log("[Strata New] SessionList mounted, loading sessions")
