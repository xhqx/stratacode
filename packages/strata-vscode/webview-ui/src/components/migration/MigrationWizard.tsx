...
// ---------------------------------------------------------------------------
// StrataLogo — replicates the pattern from MessageList.tsx
// ---------------------------------------------------------------------------

const StrataLogo = (): JSX.Element => {
  const iconsBaseUri = (window as { ICONS_BASE_URI?: string }).ICONS_BASE_URI || ""
  const icon = "strata-icon.svg"
  return (
      ...
      <div class="migration-wizard__container">
        ...
        <div class={screen() === "whats-new" ? "migration-wizard__screen--active" : "migration-wizard__screen--hidden"}>
          ...
          <div class="migration-wizard__blog-link">
            <a href="https://blog.strata.ai/p/new-strata-for-vs-code-is-live">
              {language.t("migration.whatsNew.blogLink")} <span>&rarr;</span>
            </a>
            <a href="https://strata.ai/docs/code-with-ai/platforms/vscode/whats-new">
