export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Strata",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Strata.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Strata.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Strata.",
  ...
  "dialog.server.description": "Skift hvilken Strata-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Strata ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Strata-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Strata understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Strata inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Strata",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Strata ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Strata er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Strata starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Strata.",
  ...
  "settings.providers.betaNotice":
    "I øjeblikket kan kun Strata Gateway-udbyderen konfigureres i indstillingsgrænsefladen. Understøttelse af konfiguration af andre udbydere kommer snart i løbet af betaperioden. I mellemtiden kan du konfigurere udbydere via CLI eller konfigurationsfilen. Vi er dedikerede til at holde Strata åben, ingen lock-in.",
  ...
  "settings.config.title": "Åbn {{scope}} Strata konfigurationsfil",
  "settings.config.placeholder":
    "Konfigurationsfiler flettes i rækkefølge; filer markeret som indlæst påvirker i øjeblikket indstillingerne.",
  "settings.config.noWorkspace": "Åbn en arbejdsområdemappe for at redigere den lokale Strata konfigurationsfil.",
  "settings.config.openFailed": "Kunne ikke åbne {{scope}} Strata konfigurationsfil: {{message}}",
  ...
  "settings.config.source.projectStratacode": "Forældet .stratacode konfiguration",
  ...
  "session.cloud.import.placeholder": "Sessions-ID, URL eller strata import-kommando",
  ...
  "deviceAuth.title": "Log ind på Strata Code",
  ...
  "profile.action.login": "Log ind med Strata Code",
  ...
  "session.messages.welcome":
    "Strata Code er en AI-kodningsassistent. Bed den om at bygge funktioner, rette fejl eller forklare din kodebase.",
  ...
  "settings.aboutStrataCode.status.connected": "Forbundet",
  "settings.aboutStrataCode.status.connecting": "Forbinder...",
  "settings.aboutStrataCode.status.disconnected": "Afbrudt",
  "settings.aboutStrataCode.status.error": "Fejl",
  ...
  "settings.aboutStrataCode.versionInfo": "Versionsinformation",
  "settings.aboutStrataCode.version.label": "Version:",
  "settings.aboutStrataCode.extensionName": "Strata Code-udvidelse",
  "settings.aboutStrataCode.community": "Fællesskab og support",
  ...
  "settings.aboutStrataCode.support.prefix": "For fakturerings- eller kontospørgsmål, kontakt kundesupport på",
  "settings.aboutStrataCode.resetSettings.title": "Nulstil indstillinger",
  ...
  "settings.aboutStrataCode.resetSettings.button": "Nulstil alle indstillinger",
  "settings.aboutStrataCode.settingsTransfer.title": "Overførsel af indstillinger",
  ...
  "settings.aboutStrataCode.exportSettings": "Eksportér",
  "settings.aboutStrataCode.importSettings": "Importér",
  "settings.aboutStrataCode.importSettings.invalidJson": "Ugyldig JSON-fil. Vælg venligst en gyldig indstillingsfil.",
  "settings.aboutStrataCode.importSettings.invalidConfig": "Filen indeholder ikke gyldige Strata-indstillinger.",
  "settings.aboutStrataCode.importSettings.tooLarge": "Filen er for stor. Indstillingsfiler skal være under 1 MB.",
  "settings.aboutStrataCode.importSettings.newerVersion":
    "Denne fil blev eksporteret fra en nyere version af Strata. Nogle indstillinger kan blive ignoreret.",
  ...
  "settings.aboutStrataCode.telemetry.openSettings": "Åbn telemetriindstillinger",
  ...
  "settings.language.description": 'Vælg sproget til Strata Code-brugerfladen. "Auto" bruger VS Codes visningssprog.',
  ...
  "settings.experimental.remote.description":
    "Aktivér Remote-styring af sessioner via Strata Cloud. Dette vil også påvirke CLI'er på denne maskine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Indlæs CLAUDE.md-instruktioner og -færdigheder fra din Claude Code-konfigurationsmappe i sessioner. Aktivér dette, hvis du vil have Strata til at bruge dine Claude Code-instruktioner og -færdigheder. Kræver genstart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigureret. Tilføj MCP-servere i strata.jsonc, eller bed agenten om at tilføje dem.",
  ...
  "settings.aboutStrataCode.legacyMigration.title": "Legacy-migrering",
  "settings.aboutStrataCode.legacyMigration.description":
    "Migrer indstillinger fra en tidligere installation af Strata Code, herunder udbyder API-nøgler og standardmodel.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nyheder i Strata Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én lille, effektiv kerne på tværs af alle Strata-produkter. En velkendt oplevelse uanset hvordan du vælger at arbejde.",
