export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Strata",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Strata.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Strata.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Strata.",
  ...
  "dialog.server.description": "Trocar para qual servidor Strata este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Strata ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Strata",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Strata ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Strata inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Strata",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Strata aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Strata é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Strata iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Strata.",
  ...
  "settings.providers.betaNotice":
    "Atualmente, apenas o provedor Strata Gateway pode ser configurado na interface de configurações. O suporte para a configuração de outros provedores estará disponível em breve durante o período beta. Enquanto isso, você pode configurar provedores usando a CLI ou o arquivo de configuração. Estamos comprometidos em manter o Strata aberto, sem lock-in.",
  ...
  "settings.config.title": "Abrir arquivo de configuração {{scope}} do Strata",
  ...
  "settings.config.noWorkspace":
    "Abra uma pasta de espaço de trabalho para editar o arquivo de configuração local do Strata.",
  "settings.config.openFailed": "Falha ao abrir o arquivo de configuração {{scope}} do Strata: {{message}}",
  "settings.config.source.xdg": "Configuração global do XDG",
  "settings.config.source.homeStrata": "Configuração .strata da Home",
  "settings.config.source.homeStratacode": "Configuração .stratacode da Home",
  "settings.config.source.homeOpencode": "Configuração .opencode da Home",
  "settings.config.source.envFile": "Arquivo de ambiente STRATA_CONFIG",
  "settings.config.source.envDir": "STRATA_CONFIG_DIR",
  "settings.config.source.envContent": "Configuração de ambiente embutida",
  "settings.config.source.projectStrata": "Configuração .strata do projeto",
  "settings.config.source.projectRoot": "Configuração raiz do projeto",
  "settings.config.source.projectStratacode": "Configuração .stratacode legada",
  ...
  "session.cloud.import.placeholder": "ID da sessão, URL ou comando strata import",
  ...
  "deviceAuth.title": "Entrar no Strata Code",
  ...
  "profile.action.login": "Entrar com Strata Code",
  ...
  "settings.session.title": "Contexto",
  ...
  "settings.aboutStrataCode.title": "Sobre o Strata Code",

  "session.messages.empty": "Inicie uma conversa digitando uma mensagem abaixo.",
  "session.messages.welcome":
    "Strata Code é um assistente de programação com IA. Peça para criar funcionalidades, corrigir bugs ou explicar sua base de código.",
  ...
  "settings.aboutStrataCode.status.connected": "Conectado",
  "settings.aboutStrataCode.status.connecting": "Conectando...",
  "settings.aboutStrataCode.status.disconnected": "Desconectado",
  "settings.aboutStrataCode.status.error": "Erro",
  "settings.aboutStrataCode.cliServer": "Servidor CLI",
  "settings.aboutStrataCode.status.label": "Status:",
  "settings.aboutStrataCode.port.label": "Porta:",
  "settings.aboutStrataCode.versionInfo": "Informações da Versão",
  "settings.aboutStrataCode.version.label": "Versão:",
  "settings.aboutStrataCode.extensionName": "Extensão Strata Code",
  "settings.aboutStrataCode.community": "Comunidade e Suporte",
  "settings.aboutStrataCode.feedback.prefix": "Se você tiver perguntas ou feedback, abra uma issue no",
  ...
  "settings.aboutStrataCode.resetSettings.title": "Redefinir Configurações",
  ...
  "settings.aboutStrataCode.resetSettings.button": "Redefinir Todas as Configurações",
  "settings.aboutStrataCode.settingsTransfer.title": "Transferência de configurações",
  ...
  "settings.aboutStrataCode.exportSettings": "Exportar",
  "settings.aboutStrataCode.importSettings": "Importar",
  "settings.aboutStrataCode.importSettings.invalidJson":
    "Arquivo JSON inválido. Selecione um arquivo de configurações válido.",
  "settings.aboutStrataCode.importSettings.invalidConfig": "O arquivo não contém configurações válidas do Strata.",
  ...
  "settings.aboutStrataCode.importSettings.newerVersion":
    "Este arquivo foi exportado de uma versão mais recente do Strata. Algumas configurações podem ser ignoradas.",
  "settings.aboutStrataCode.importSettings.success":
    "Configurações importadas. Revise as alterações acima e clique em Salvar.",

  "settings.aboutStrataCode.telemetry.title": "Telemetria",
  ...
  "settings.aboutStrataCode.telemetry.openSettings": "Abrir Configurações de Telemetria",
  ...
  "settings.language.description":
    'Escolha o idioma da interface do Strata Code. "Auto" usa o idioma de exibição do VS Code.',
  ...
  "settings.experimental.remote.description":
    "Habilite o controle Remote de sessões via Strata Cloud. Isso também afetará as CLIs nesta máquina.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carrega as instruções e skills do CLAUDE.md a partir do seu diretório de configuração do Claude Code para as sessões. Ative esta opção se deseja que o Strata utilize suas instruções e skills do Claude Code. Requer reinicialização.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nenhum servidor MCP configurado. Adicione servidores MCP em strata.jsonc ou peça ao agente para adicioná-los.",
  ...
  "settings.session.watcherPatterns": "Padrões de ignorar do observador",
  "settings.session.watcherPatterns.description": "Padrões glob para arquivos que o observador deve ignorar",
  ...
  "settings.aboutStrataCode.legacyMigration.title": "Migração Legada",
  "settings.aboutStrataCode.legacyMigration.description":
    "Migre as configurações de uma instalação anterior do Strata Code, incluindo chaves de API de provedor e modelo padrão.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "O Que Há de Novo no Strata Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Um núcleo pequeno e eficiente em todos os produtos Strata. Uma experiência familiar independentemente de como você escolha trabalhar.",
