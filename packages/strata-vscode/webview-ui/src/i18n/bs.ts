export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Strata",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Strata-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Strata-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Strata-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Strata server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Strata-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Strata timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Strata još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Strata uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Strata-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Strata izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Strata-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Strata pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Strata-a.",
  ...
  "settings.providers.betaNotice":
    "Trenutno se samo Strata Gateway provajder može konfigurisati u interfejsu za postavke. Podrška za konfigurisanje drugih provajdera stiže uskoro tokom beta perioda. U međuvremenu, provajdere možete konfigurisati koristeći CLI ili konfiguracijsku datoteku. Posvećeni smo tome da Strata ostane otvoren, bez vezivanja.",
  ...
  "settings.config.source.homeStratacode": "Home .stratacode konfiguracija",
  "settings.config.source.homeOpencode": "Home .opencode konfiguracija",
  "settings.config.source.envFile": "STRATA_CONFIG datoteka okruženja",
  "settings.config.source.envDir": "STRATA_CONFIG_DIR",
  "settings.config.source.envContent": "Ugrađena konfiguracija okruženja",
  "settings.config.source.projectStrata": "Projektna .strata konfiguracija",
  "settings.config.source.projectRoot": "Konfiguracija korijena projekta",
  "settings.config.source.projectStratacode": "Zastarjela .stratacode konfiguracija",
  ...
  "session.cloud.import.placeholder": "ID sesije, URL ili strata import naredba",
  ...
  "deviceAuth.title": "Prijavite se u Strata Code",
  ...
  "profile.action.login": "Prijavite se putem Strata Code",
  ...
  "settings.aboutStrataCode.title": "O Strata Code-u",

  "session.messages.empty": "Započnite razgovor unosom poruke ispod.",
  "session.messages.welcome":
    "Strata Code je AI asistent za programiranje. Zatražite da gradi funkcionalnosti, ispravlja greške ili objasni vašu bazu koda.",
  ...
  "settings.aboutStrataCode.status.connected": "Povezano",
  "settings.aboutStrataCode.status.connecting": "Povezivanje...",
  "settings.aboutStrataCode.status.disconnected": "Odspojeno",
  "settings.aboutStrataCode.status.error": "Greška",
  ...
  "settings.aboutStrataCode.versionInfo": "Informacije o verziji",
  "settings.aboutStrataCode.version.label": "Verzija:",
  "settings.aboutStrataCode.extensionName": "Strata Code ekstenzija",
  "settings.aboutStrataCode.community": "Zajednica i podrška",
  "settings.aboutStrataCode.feedback.prefix": "Ako imate pitanja ili povratne informacije, slobodno otvorite issue na",
  "settings.aboutStrataCode.feedback.or": "ili",
  "settings.aboutStrataCode.support.prefix": "Za pitanja o naplati ili računu, kontaktirajte korisničku podršku na",
  "settings.aboutStrataCode.resetSettings.title": "Resetovanje postavki",
  ...
  "settings.aboutStrataCode.resetSettings.button": "Resetuj sve postavke",
  "settings.aboutStrataCode.settingsTransfer.title": "Prijenos postavki",
  "settings.aboutStrataCode.settingsTransfer.description":
    "Izvezite ili uvezite postavke za prijenos između VS Code instanci.",
  "settings.aboutStrataCode.exportSettings": "Izvezi",
  ...
  "settings.aboutStrataCode.telemetry.title": "Telemetrija",
  ...
  "settings.aboutStrataCode.telemetry.openSettings": "Otvori postavke telemetrije",
  ...
  "settings.language.description": 'Odaberite jezik za Strata Code sučelje. "Auto" koristi jezik prikaza VS Code-a.',
  ...
  "settings.experimental.remote.description":
    "Omogućite Remote kontrolu sesija putem Strata Cloud. Ovo će također utjecati na CLI-jeve na ovoj mašini.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Učitajte CLAUDE.md instrukcije i vještine iz vašeg Claude Code konfiguracijskog direktorija u sesije. Omogućite ovo ako želite da Strata koristi vaše Claude Code instrukcije i vještine. Zahtijeva ponovno pokretanje.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nema konfiguriranih MCP servera. Dodajte MCP servere u strata.jsonc ili zamolite agenta da ih doda.",
  ...
  "settings.aboutStrataCode.legacyMigration.title": "Migracija sa prethodne verzije",
  "settings.aboutStrataCode.legacyMigration.description":
    "Migrirajte postavke iz prethodne instalacije Strata Code, uključujući API ključeve provajdera i podrazumijevani model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Šta je novo u Strata Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno malo, efikasno jezgro kroz sve Strata proizvode. Poznato iskustvo bez obzira na to kako odaberete raditi.",
