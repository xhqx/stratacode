...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Strata 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Strata 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Strata 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Strata 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 Strata 服务器。",
  ...
  "toast.update.description": "Strata 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Strata 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Strata 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Strata 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 Strata 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Strata 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Strata 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Strata 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Strata。",
  ...
  "settings.providers.betaNotice":
    "目前只能在设置界面中配置 Strata Gateway 提供商。在 Beta 测试期间即将支持配置其他提供商。在此期间，您可以使用 CLI 或配置文件来配置提供商。我们致力于保持 Strata 开放，无锁定。",
  ...
  "settings.config.title": "打开 {{scope}} Strata 配置文件",
  "settings.config.placeholder": "配置文件按顺序合并；标记为已加载的文件目前会影响设置。",
  "settings.config.noWorkspace": "打开工作区文件夹以编辑本地 Strata 配置文件。",
  "settings.config.openFailed": "无法打开 {{scope}} Strata 配置文件：{{message}}",
  "settings.config.source.xdg": "XDG 全局配置",
  "settings.config.source.homeStrata": "主目录 .strata 配置",
  "settings.config.source.homeStratacode": "主目录 .stratacode 配置",
  "settings.config.source.homeOpencode": "主目录 .opencode 配置",
  "settings.config.source.envFile": "STRATA_CONFIG 环境变量文件",
  "settings.config.source.envDir": "STRATA_CONFIG_DIR",
  "settings.config.source.envContent": "内联环境配置",
  "settings.config.source.projectStrata": "项目 .strata 配置",
  "settings.config.source.projectRoot": "项目根目录配置",
  "settings.config.source.projectStratacode": "旧版 .stratacode 配置",
  ...
  "session.cloud.import.placeholder": "会话 ID、URL 或 strata import 命令",
  ...
  "deviceAuth.title": "登录 Strata Code",
  ...
  "profile.action.login": "使用 Strata Code 登录",
  ...
  "settings.aboutStrataCode.title": "关于 Strata Code",

  "session.messages.empty": "在下方输入消息以开始对话。",
  "session.messages.welcome": "Strata Code 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "settings.aboutStrataCode.status.connected": "已连接",
  "settings.aboutStrataCode.status.connecting": "连接中...",
  "settings.aboutStrataCode.status.disconnected": "已断开",
  "settings.aboutStrataCode.status.error": "错误",
  "settings.aboutStrataCode.cliServer": "CLI 服务器",
  "settings.aboutStrataCode.status.label": "状态：",
  "settings.aboutStrataCode.port.label": "端口：",
  "settings.aboutStrataCode.versionInfo": "版本信息",
  "settings.aboutStrataCode.version.label": "版本：",
  "settings.aboutStrataCode.extensionName": "Strata Code 扩展",
  "settings.aboutStrataCode.community": "社区与支持",
  "settings.aboutStrataCode.feedback.prefix": "如果您有任何问题或反馈，欢迎在以下平台提交 issue",
  "settings.aboutStrataCode.feedback.or": "或",
  "settings.aboutStrataCode.support.prefix": "如有账单或账户问题，请联系客户支持",
  "settings.aboutStrataCode.resetSettings.title": "重置设置",
  "settings.aboutStrataCode.resetSettings.description":
    "此操作仅将 VS Code 扩展专属设置重置为默认值。与 CLI 共享的设置（如模式和自动审批规则）存储在 CLI 配置中，不会被重置。",
  "settings.aboutStrataCode.resetSettings.button": "重置所有设置",
  "settings.aboutStrataCode.settingsTransfer.title": "设置迁移",
  "settings.aboutStrataCode.settingsTransfer.description": "导出或导入设置，以便在 VS Code 实例之间传输。",
  "settings.aboutStrataCode.exportSettings": "导出",
  "settings.aboutStrataCode.importSettings": "导入",
  "settings.aboutStrataCode.importSettings.invalidJson": "无效的 JSON 文件。请选择有效的设置文件。",
  "settings.aboutStrataCode.importSettings.invalidConfig": "文件不包含有效的 Strata 设置。",
  "settings.aboutStrataCode.importSettings.tooLarge": "文件过大。设置文件必须小于 1 MB。",
  "settings.aboutStrataCode.importSettings.newerVersion": "此文件由较新版本的 Strata 导出。部分设置可能会被忽略。",
  "settings.aboutStrataCode.importSettings.success": "设置已导入。请查看上方的更改，然后点击保存。",

  "settings.aboutStrataCode.telemetry.title": "遥测",
  "settings.aboutStrataCode.telemetry.description":
    '遥测由 VS Code 的内置遥测设置控制。若要将其禁用，请转到「设置」>「遥测」>「遥测级别」并将其设置为 "off"。重启 VS Code 以应用更改。',
  "settings.aboutStrataCode.telemetry.openSettings": "打开遥测设置",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 Strata Code 界面的语言。',
  ...
  "settings.experimental.remote.description": "通过 Strata Cloud 启用会话的 Remote 控制。这也会影响此计算机上的 CLI。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "将 Claude Code 配置目录中的 CLAUDE.md 指令和技能加载到会话中。如果您希望 Strata 使用您的 Claude Code 指令和技能，请启用此选项。需要重启。",
  ...
  "settings.agentBehaviour.mcpEmpty": "未配置 MCP 服务器。在 strata.jsonc 中添加 MCP 服务器，或让代理为您添加。",
  ...
  "settings.session.watcherPatterns": "文件监视器忽略模式",
  "settings.session.watcherPatterns.description": "监视器应忽略的文件的 glob 模式",
  ...
  "settings.aboutStrataCode.legacyMigration.title": "旧版迁移",
  "settings.aboutStrataCode.legacyMigration.description":
    "从旧版 Strata Code 安装迁移设置，包括提供商 API 密钥和默认模型。",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Strata Code 新功能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Strata 产品共享一个小巧高效的核心。无论你选择哪种方式工作，都能获得熟悉的体验。",
