export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Strataが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Strataで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してStrataで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Strataで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するStrataサーバーを切り替えます。",
  ...
  "toast.update.description": "Strataの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをStrataチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: StrataはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Strataには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.general.row.language.description": "Strataの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのStrataの表示をカスタマイズします",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Strataのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Strata の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Strata は最新バージョンです。",
  ...
  "settings.providers.betaNotice":
    "現在、設定画面で設定できるのはStrata Gatewayプロバイダーのみです。他のプロバイダーの設定については、ベータ期間中にまもなく対応予定です。それまでの間は、CLIまたは設定ファイルを使用してプロバイダーを設定できます。私たちはStrataをオープンに保ち、ロックインのない状態を維持することをお約束します。",
  ...
  "settings.config.source.homeStratacode": "Homeの.stratacode構成",
  "settings.config.source.homeOpencode": "Homeの.opencode構成",
  "settings.config.source.envFile": "STRATA_CONFIG環境ファイル",
  "settings.config.source.envDir": "STRATA_CONFIG_DIR",
  "settings.config.source.envContent": "インライン環境構成",
  "settings.config.source.projectStrata": "プロジェクトの.strata構成",
  "settings.config.source.projectRoot": "プロジェクトルート構成",
  "settings.config.source.projectStratacode": "旧.stratacode構成",
  ...
  "session.cloud.import.placeholder": "セッションID、URL、またはstrata importコマンド",
  ...
  "deviceAuth.title": "Strata Codeにサインイン",
  ...
  "profile.action.login": "Strata Codeでログイン",
  ...
  "settings.aboutStrataCode.title": "Strata Codeについて",

  "session.messages.empty": "下にメッセージを入力して会話を始めましょう。",
  "session.messages.welcome":
    "Strata CodeはAIコーディングアシスタントです。機能の構築、バグの修正、コードベースの説明を依頼できます。",
  ...
  "settings.aboutStrataCode.status.connected": "接続済み",
  "settings.aboutStrataCode.status.connecting": "接続中...",
  "settings.aboutStrataCode.status.disconnected": "切断",
  "settings.aboutStrataCode.status.error": "エラー",
  "settings.aboutStrataCode.cliServer": "CLIサーバー",
  "settings.aboutStrataCode.status.label": "ステータス：",
  "settings.aboutStrataCode.port.label": "ポート：",
  "settings.aboutStrataCode.versionInfo": "バージョン情報",
  "settings.aboutStrataCode.version.label": "バージョン：",
  "settings.aboutStrataCode.extensionName": "Strata Code拡張機能",
  "settings.aboutStrataCode.community": "コミュニティとサポート",
  "settings.aboutStrataCode.feedback.prefix": "ご質問やフィードバックがありましたら、お気軽にissueを作成してください",
  "settings.aboutStrataCode.feedback.or": "または",
  "settings.aboutStrataCode.support.prefix":
    "請求やアカウントに関するご質問は、カスタマーサポートまでお問い合わせください",
  "settings.aboutStrataCode.resetSettings.title": "設定をリセット",
  ...
  "settings.aboutStrataCode.resetSettings.button": "すべての設定をリセット",
  "settings.aboutStrataCode.settingsTransfer.title": "設定の移行",
  "settings.aboutStrataCode.settingsTransfer.description":
    "VS Code インスタンス間で設定を転送するには、エクスポートまたはインポートしてください。",
  "settings.aboutStrataCode.exportSettings": "エクスポート",
  "settings.aboutStrataCode.importSettings": "インポート",
  ...
  "settings.aboutStrataCode.telemetry.title": "テレメトリ",
  ...
  "settings.aboutStrataCode.telemetry.openSettings": "テレメトリ設定を開く",
  ...
  "settings.language.description": "Strata Code UIの言語を選択します。「自動」はVS Codeの表示言語を使用します。",
  ...
  "settings.experimental.remote.description":
    "Strata Cloud 経由でのセッションの Remote コントロールを有効にします。これはこのマシンの CLI にも影響します。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code の設定ディレクトリから CLAUDE.md のインストラクションとスキルをセッションに読み込みます。Strata に Claude Code のインストラクションとスキルを使用させる場合は、これを有効にしてください。再起動が必要です。",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCPサーバーが設定されていません。strata.jsoncでMCPサーバーを追加するか、エージェントに追加を依頼してください。",
  ...
  "settings.aboutStrataCode.legacyMigration.title": "レガシー移行",
  "settings.aboutStrataCode.legacyMigration.description":
    "プロバイダーのAPIキーやデフォルトモデルなど、以前にインストールしたStrata Codeから設定を移行します。",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Strata Codeの新機能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "すべてのStrata製品で共有される小さく効率的なコア。どのような作業スタイルでも馴染みのある体験を提供します。",
