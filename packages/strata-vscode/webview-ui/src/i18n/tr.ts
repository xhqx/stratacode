export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Strata tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Strata'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Strata'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Strata sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Strata'nun yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Strata ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Strata henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Strata ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Strata Masaüstü",
  ...
  "settings.general.row.language.description": "Strata'nun görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Strata'nun cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Strata'nun temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Strata başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Strata'nun en son sürümünü kullanıyorsunuz.",
  ...
  "settings.providers.betaNotice":
    "Şu anda yalnızca Strata Gateway sağlayıcısı ayarlar arayüzünde yapılandırılabilir. Diğer sağlayıcılar için destek beta döneminde yakında gelecek. Bu arada CLI veya yapılandırma dosyası ile sağlayıcıları yapılandırabilirsiniz. Strata'yu açık tutmaya kararlıyız, kilitlenme yok.",
  ...
  "settings.config.title": "{{scope}} Strata yapılandırma dosyasını aç",
  "settings.config.placeholder":
    "Yapılandırma dosyaları sırayla birleştirilir; yüklendi olarak işaretlenen dosyalar şu anda ayarları etkiler.",
  "settings.config.noWorkspace": "Yerel Strata yapılandırma dosyasını düzenlemek için bir çalışma alanı klasörü açın.",
  "settings.config.openFailed": "{{scope}} Strata yapılandırma dosyası açılamadı: {{message}}",
  "settings.config.source.xdg": "XDG küresel yapılandırma",
  "settings.config.source.homeStrata": "Home .strata yapılandırması",
  "settings.config.source.homeStratacode": "Home .stratacode yapılandırması",
  "settings.config.source.homeOpencode": "Home .opencode yapılandırması",
  "settings.config.source.envFile": "STRATA_CONFIG ortam dosyası",
  "settings.config.source.envDir": "STRATA_CONFIG_DIR",
  "settings.config.source.envContent": "Satır içi ortam yapılandırması",
  "settings.config.source.projectStrata": "Proje .strata yapılandırması",
  "settings.config.source.projectRoot": "Proje kök yapılandırması",
  "settings.config.source.projectStratacode": "Eski .stratacode yapılandırması",
  ...
  "session.cloud.import.placeholder": "Oturum kimliği, URL veya strata import komutu",
  ...
  "deviceAuth.title": "Strata Code'a giriş yap",
  ...
  "profile.action.login": "Strata Code ile giriş yap",
  ...
  "settings.aboutStrataCode.title": "Strata Code Hakkında",

  "session.messages.empty": "Aşağıya bir mesaj yazarak sohbete başlayın.",
  "session.messages.welcome":
    "Strata Code bir yapay zeka kodlama asistanıdır. Özellik geliştirmesini, hata düzeltmesini veya kod tabanınızı açıklamasını isteyin.",
  ...
  "settings.aboutStrataCode.status.connected": "Bağlı",
  "settings.aboutStrataCode.status.connecting": "Bağlanıyor...",
  "settings.aboutStrataCode.status.disconnected": "Bağlantı Kesildi",
  "settings.aboutStrataCode.status.error": "Hata",
  "settings.aboutStrataCode.cliServer": "CLI Sunucusu",
  "settings.aboutStrataCode.status.label": "Durum:",
  "settings.aboutStrataCode.port.label": "Port:",
  "settings.aboutStrataCode.versionInfo": "Sürüm Bilgisi",
  "settings.aboutStrataCode.version.label": "Sürüm:",
  "settings.aboutStrataCode.extensionName": "Strata Code Uzantısı",
  "settings.aboutStrataCode.community": "Topluluk ve Destek",
  ...
  "settings.aboutStrataCode.feedback.or": "veya",
  "settings.aboutStrataCode.support.prefix": "Faturalama veya hesap soruları için Müşteri Desteği ile iletişime geçin:",
  "settings.aboutStrataCode.resetSettings.title": "Ayarları Sıfırla",
  ...
  "settings.aboutStrataCode.resetSettings.button": "Tüm Ayarları Sıfırla",
  "settings.aboutStrataCode.settingsTransfer.title": "Ayar Aktarımı",
  ...
  "settings.aboutStrataCode.importSettings.newerVersion":
    "Bu dosya Strata'nun daha yeni bir sürümünden dışa aktarılmış. Bazı ayarlar göz ardı edilebilir.",
  ...
  "settings.aboutStrataCode.telemetry.openSettings": "Telemetri Ayarlarını Aç",
  ...
  "settings.language.description":
    '"Otomatik" VS Code görüntüleme dilinizi kullanır. Strata Code arayüzü için dil seçin.',
  ...
  "settings.experimental.remote.description":
    "Strata Cloud üzerinden oturumların Remote kontrolünü etkinleştirin. Bu, bu makinedeki CLI'leri de etkileyecektir.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code yapılandırma dizininizdeki CLAUDE.md talimatlarını ve becerilerini oturumlara yükleyin. Strata'nun Claude Code talimatlarınızı ve becerilerinizi kullanmasını istiyorsanız bunu etkinleştirin. Yeniden başlatma gerektirir.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Yapılandırılmış MCP sunucusu yok. strata.jsonc dosyasına MCP sunucuları ekleyin veya ajanın eklemesini isteyin.",
  ...
  "settings.session.watcherPatterns": "Dosya İzleyici Yok Sayma Kalıpları",
  "settings.session.watcherPatterns.description": "İzleyicinin yok sayması gereken dosyalar için glob kalıpları",
  ...
  "settings.aboutStrataCode.legacyMigration.title": "Eski Sürüm Taşıma",
  "settings.aboutStrataCode.legacyMigration.description":
    "Sağlayıcı API anahtarları ve varsayılan model dahil olmak üzere Strata Code'un önceki yüklemesinden ayarları taşıyın.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Strata Code'daki Yenilikler",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Her Strata ürününde küçük ve verimli bir çekirdek. Nasıl çalışmayı tercih ederseniz edin, tanıdık bir deneyim.",
