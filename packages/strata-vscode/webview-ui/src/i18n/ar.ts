export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Strata",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Strata.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Strata.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Strata.",
  ...
  "dialog.server.description": "تبديل خادم Strata الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من Strata ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Strata",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Strata لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Strata نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Strata",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Strata على جهازك",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Strata.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Strata",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Strata.",
  ...
  "settings.providers.betaNotice":
    "حالياً، يمكن إعداد مزود Strata Gateway فقط في واجهة الإعدادات. سيتوفر دعم إعداد المزودين الآخرين قريباً خلال الفترة التجريبية. في غضون ذلك، يمكنك إعداد المزودين باستخدام CLI أو ملف التكوين. نحن ملتزمون بإبقاء Strata مفتوحاً، دون تقييد.",
  ...
  "settings.config.title": "فتح ملف تكوين Strata {{scope}}",
  "settings.config.placeholder": "يتم دمج ملفات التكوين بالترتيب؛ الملفات المحددة كمحملة تؤثر حاليًا على الإعدادات.",
  "settings.config.noWorkspace": "افتح مجلد مساحة عمل لتحرير ملف تكوين Strata المحلي.",
  "settings.config.openFailed": "فشل فتح ملف تكوين Strata {{scope}}: {{message}}",
  "settings.config.source.xdg": "تكوين XDG العالمي",
  "settings.config.source.homeStrata": "تكوين .strata في Home",
  "settings.config.source.homeStratacode": "تكوين .stratacode في Home",
  "settings.config.source.homeOpencode": "تكوين .opencode في Home",
  "settings.config.source.envFile": "ملف بيئة STRATA_CONFIG",
  "settings.config.source.envDir": "STRATA_CONFIG_DIR",
  "settings.config.source.envContent": "تكوين البيئة المضمن",
  "settings.config.source.projectStrata": "تكوين .strata للمشروع",
  "settings.config.source.projectRoot": "تكوين جذر المشروع",
  "settings.config.source.projectStratacode": "تكوين .stratacode القديم",
  ...
  "session.cloud.import.placeholder": "معرّف الجلسة أو الرابط أو أمر strata import",
  ...
  "deviceAuth.title": "تسجيل الدخول إلى Strata Code",
  ...
  "profile.action.login": "تسجيل الدخول باستخدام Strata Code",
  ...
  "settings.aboutStrataCode.title": "حول Strata Code",

  "session.messages.empty": "ابدأ محادثة بكتابة رسالة أدناه.",
  "session.messages.welcome":
    "Strata Code هو مساعد ترميز بالذكاء الاصطناعي. اطلب منه بناء ميزات أو إصلاح أخطاء أو شرح قاعدة الشيفرة.",
  ...
  "settings.aboutStrataCode.status.connected": "متصل",
  "settings.aboutStrataCode.status.connecting": "جارٍ الاتصال...",
  "settings.aboutStrataCode.status.disconnected": "غير متصل",
  "settings.aboutStrataCode.status.error": "خطأ",
  "settings.aboutStrataCode.cliServer": "خادم CLI",
  "settings.aboutStrataCode.status.label": "الحالة:",
  "settings.aboutStrataCode.port.label": "المنفذ:",
  "settings.aboutStrataCode.versionInfo": "معلومات الإصدار",
  "settings.aboutStrataCode.version.label": "الإصدار:",
  "settings.aboutStrataCode.extensionName": "إضافة Strata Code",
  "settings.aboutStrataCode.community": "المجتمع والدعم",
  "settings.aboutStrataCode.feedback.prefix": "إذا كان لديك أي أسئلة أو ملاحظات، لا تتردد في فتح مشكلة على",
  "settings.aboutStrataCode.feedback.or": "أو",
  "settings.aboutStrataCode.support.prefix": "لأسئلة الفوترة أو الحساب، تواصل مع دعم العملاء على",
  "settings.aboutStrataCode.resetSettings.title": "إعادة تعيين الإعدادات",
  ...
  "settings.aboutStrataCode.resetSettings.button": "إعادة تعيين جميع الإعدادات",
  "settings.aboutStrataCode.settingsTransfer.title": "نقل الإعدادات",
  "settings.aboutStrataCode.settingsTransfer.description": "تصدير أو استيراد إعداداتك لنقلها بين نُسخ VS Code.",
  "settings.aboutStrataCode.exportSettings": "تصدير",
  "settings.aboutStrataCode.importSettings": "استيراد",
  "settings.aboutStrataCode.importSettings.invalidJson": "ملف JSON غير صالح. يرجى اختيار ملف إعدادات صالح.",
  "settings.aboutStrataCode.importSettings.invalidConfig": "الملف لا يحتوي على إعدادات Strata صالحة.",
  "settings.aboutStrataCode.importSettings.tooLarge": "الملف كبير جدًا. يجب أن تكون ملفات الإعدادات أقل من 1 MB.",
  "settings.aboutStrataCode.importSettings.newerVersion":
    "تم تصدير هذا الملف من إصدار أحدث من Strata. قد يتم تجاهل بعض الإعدادات.",
  "settings.aboutStrataCode.importSettings.success": "تم استيراد الإعدادات. راجع التغييرات أعلاه، ثم انقر على حفظ.",
  ...
  "settings.aboutStrataCode.telemetry.openSettings": "فتح إعدادات Telemetry",
  ...
  "settings.language.description": 'اختر اللغة لواجهة Strata Code. "تلقائي" يستخدم لغة عرض VS Code.',
  ...
  "settings.experimental.remote.description":
    "قم بتمكين التحكم Remote في الجلسات عبر Strata Cloud. سيؤثر هذا أيضًا على واجهات سطر الأوامر (CLIs) على هذا الجهاز.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "تحميل تعليمات ومهارات CLAUDE.md من مجلد إعدادات Claude Code إلى الجلسات. قم بتمكين هذا الخيار إذا كنت ترغب في أن يستخدم Strata مهارات وتعليمات Claude Code الخاصة بك. يتطلب إعادة التشغيل.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "لم يتم تهيئة خوادم MCP. أضف خوادم MCP في strata.jsonc، أو اطلب من الوكيل إضافتها لك.",
  ...
  "settings.session.watcherPatterns": "أنماط تجاهل مراقب الملفات",
  "settings.session.watcherPatterns.description": "أنماط glob للملفات التي يجب على المراقب تجاهلها",
  ...
  "settings.aboutStrataCode.legacyMigration.title": "ترحيل الإصدار القديم",
  "settings.aboutStrataCode.legacyMigration.description":
    "ترحيل الإعدادات من تثبيت سابق لـ Strata Code، بما في ذلك مفاتيح API لمقدمي الخدمة والنموذج الافتراضي.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "ما الجديد في Strata Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "نواة صغيرة وفعالة واحدة عبر كل منتجات Strata. تجربة مألوفة بغض النظر عن طريقة عملك.",
