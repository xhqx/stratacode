...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Strata 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Strata 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Strata 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 Strata 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 Strata 伺服器。",
  ...
  "toast.update.description": "Strata 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Strata 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意：Strata 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Strata 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 Strata 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Strata 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Strata 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Strata 啟動時自動檢查更新",
  ...
  "settings.providers.betaNotice":
    "目前在設定介面中僅能配置 Strata Gateway 供應商。在測試期間，即將推出配置其他供應商的支援。在此期間，您可以使用 CLI 或設定檔來配置供應商。我們致力於保持 Strata 開放，絕不綁定。",
  ...
  "settings.config.title": "開啟 {{scope}} Strata 設定檔",
  "settings.config.placeholder": "設定檔會按順序合併；標記為已載入的檔案目前會影響設定。",
  "settings.config.noWorkspace": "開啟工作區資料夾以編輯本地 Strata 設定檔。",
  "settings.config.openFailed": "無法開啟 {{scope}} Strata 設定檔：{{message}}",
  "settings.config.source.xdg": "XDG 全域設定",
  "settings.config.source.homeStrata": "主目錄 .strata 設定",
  "settings.config.source.homeStratacode": "主目錄 .stratacode 設定",
  "settings.config.source.homeOpencode": "主目錄 .opencode 設定",
  "settings.config.source.envFile": "STRATA_CONFIG 環境變數檔案",
  "settings.config.source.envDir": "STRATA_CONFIG_DIR",
  "settings.config.source.envContent": "內聯環境設定",
  "settings.config.source.projectStrata": "專案 .strata 設定",
  "settings.config.source.projectRoot": "專案根目錄設定",
  "settings.config.source.projectStratacode": "舊版 .stratacode 設定",
  ...
  "session.cloud.import.placeholder": "工作階段 ID、URL 或 strata import 指令",
  ...
  "deviceAuth.title": "登入 Strata Code",
  ...
  "profile.action.login": "使用 Strata Code 登入",
  ...
  "settings.aboutStrataCode.title": "關於 Strata Code",

  "session.messages.empty": "在下方輸入訊息以開始對話。",
  "session.messages.welcome": "Strata Code 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "settings.aboutStrataCode.status.connected": "已連線",
  "settings.aboutStrataCode.status.connecting": "連線中...",
  "settings.aboutStrataCode.status.disconnected": "已中斷",
  "settings.aboutStrataCode.status.error": "錯誤",
  "settings.aboutStrataCode.cliServer": "CLI 伺服器",
  "settings.aboutStrataCode.status.label": "狀態：",
  "settings.aboutStrataCode.port.label": "連接埠：",
  "settings.aboutStrataCode.versionInfo": "版本資訊",
  "settings.aboutStrataCode.version.label": "版本：",
  "settings.aboutStrataCode.extensionName": "Strata Code 擴充功能",
  "settings.aboutStrataCode.community": "社群與支援",
  "settings.aboutStrataCode.feedback.prefix": "如果您有任何問題或回饋，歡迎在以下平台提交 issue",
  "settings.aboutStrataCode.feedback.or": "或",
  "settings.aboutStrataCode.support.prefix": "如有帳單或帳戶問題，請聯繫客戶支援",
  "settings.aboutStrataCode.resetSettings.title": "重置設定",
  "settings.aboutStrataCode.resetSettings.description":
    "此操作僅將 VS Code 擴充功能專屬設定重置為預設值。與 CLI 共享的設定（例如模式和自動核准規則）儲存在 CLI 設定中，不會被重置。",
  "settings.aboutStrataCode.resetSettings.button": "重置所有設定",
  "settings.aboutStrataCode.settingsTransfer.title": "設定轉移",
  "settings.aboutStrataCode.settingsTransfer.description": "匯出或匯入設定，以便在 VS Code 實例之間轉移。",
  "settings.aboutStrataCode.exportSettings": "匯出",
  "settings.aboutStrataCode.importSettings": "匯入",
  "settings.aboutStrataCode.importSettings.invalidJson": "無效的 JSON 檔案。請選擇有效的設定檔。",
  "settings.aboutStrataCode.importSettings.invalidConfig": "檔案不包含有效的 Strata 設定。",
  "settings.aboutStrataCode.importSettings.tooLarge": "檔案過大。設定檔必須小於 1 MB。",
  "settings.aboutStrataCode.importSettings.newerVersion": "此檔案由較新版本的 Strata 匯出。部分設定可能會被忽略。",
  "settings.aboutStrataCode.importSettings.success": "設定已匯入。請檢視上方的變更，然後點擊儲存。",

  "settings.aboutStrataCode.telemetry.title": "遙測",
  "settings.aboutStrataCode.telemetry.description":
    '遙測由 VS Code 內建的遙測設定控制。若要停用，請前往「設定」>「遙測」>「遙測層級」並將其設為 "off"。重新啟動 VS Code 以套用變更。',
  "settings.aboutStrataCode.telemetry.openSettings": "開啟遙測設定",
  ...
  "settings.language.description": "選擇 Strata Code 介面的語言。「自動」使用 VS Code 的顯示語言。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "從您的 Claude Code 設定目錄將 CLAUDE.md 指示與技能載入至工作階段中。如果您希望 Strata 使用您的 Claude Code 指示與技能，請啟用此選項。需要重新啟動。",
  ...
  "settings.agentBehaviour.mcpEmpty": "未設定 MCP 伺服器。在 strata.jsonc 中新增 MCP 伺服器，或請代理為您新增。",
  ...
  "settings.aboutStrataCode.legacyMigration.title": "舊版遷移",
  "settings.aboutStrataCode.legacyMigration.description":
    "從舊版 Strata Code 安裝遷移設定，包括供應商 API 金鑰和預設模型。",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Strata 產品共享一個小巧高效的核心。無論你選擇哪種方式工作，都能獲得熟悉的體驗。",
