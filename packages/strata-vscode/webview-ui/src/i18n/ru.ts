export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Strata",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Strata.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Strata.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Strata.",
  ...
  "dialog.server.description": "Переключите сервер Strata к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия Strata ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Strata",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Strata пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Strata включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Strata",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как Strata выглядит на вашем устройстве",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Strata.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Strata",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Strata.",
  ...
  "settings.providers.betaNotice":
    "В настоящее время в интерфейсе настроек можно настроить только провайдер Strata Gateway. Поддержка настройки других провайдеров скоро появится в период бета-тестирования. А пока вы можете настраивать провайдеров с помощью CLI или конфигурационного файла. Мы стремимся сохранить Strata открытым — без привязки к поставщикам.",
  ...
  "settings.config.title": "Открыть файл конфигурации Strata ({{scope}})",
  ...
  "settings.config.noWorkspace":
    "Откройте папку рабочей области для редактирования локального файла конфигурации Strata.",
  "settings.config.openFailed": "Не удалось открыть файл конфигурации Strata ({{scope}}): {{message}}",
  "settings.config.source.xdg": "Глобальная конфигурация XDG",
  "settings.config.source.homeStrata": "Конфигурация .strata (Home)",
  "settings.config.source.homeStratacode": "Конфигурация .stratacode (Home)",
  "settings.config.source.homeOpencode": "Конфигурация .opencode (Home)",
  "settings.config.source.envFile": "Файл среды STRATA_CONFIG",
  "settings.config.source.envDir": "STRATA_CONFIG_DIR",
  "settings.config.source.envContent": "Встроенная конфигурация среды",
  "settings.config.source.projectStrata": "Конфигурация .strata проекта",
  "settings.config.source.projectRoot": "Корневая конфигурация проекта",
  "settings.config.source.projectStratacode": "Устаревшая конфигурация .stratacode",
  ...
  "session.cloud.import.placeholder": "ID сессии, URL или команда strata import",
  ...
  "deviceAuth.title": "Войти в Strata Code",
  ...
  "profile.action.login": "Войти через Strata Code",
  ...
  "settings.aboutStrataCode.title": "О Strata Code",

  "session.messages.empty": "Начните разговор, введя сообщение ниже.",
  "session.messages.welcome":
    "Strata Code — это AI-помощник для программирования. Попросите его создать функции, исправить ошибки или объяснить вашу кодовую базу.",
  ...
  "settings.aboutStrataCode.status.connected": "Подключено",
  "settings.aboutStrataCode.status.connecting": "Подключение...",
  "settings.aboutStrataCode.status.disconnected": "Отключено",
  "settings.aboutStrataCode.status.error": "Ошибка",
  "settings.aboutStrataCode.cliServer": "CLI-сервер",
  "settings.aboutStrataCode.status.label": "Статус:",
  "settings.aboutStrataCode.port.label": "Порт:",
  "settings.aboutStrataCode.versionInfo": "Информация о версии",
  "settings.aboutStrataCode.version.label": "Версия:",
  "settings.aboutStrataCode.extensionName": "Расширение Strata Code",
  "settings.aboutStrataCode.community": "Сообщество и поддержка",
  "settings.aboutStrataCode.feedback.prefix": "Если у вас есть вопросы или отзывы, создайте issue на",
  "settings.aboutStrataCode.feedback.or": "или",
  "settings.aboutStrataCode.support.prefix": "По вопросам оплаты или аккаунта обращайтесь в службу поддержки по адресу",
  "settings.aboutStrataCode.resetSettings.title": "Сброс настроек",
  ...
  "settings.aboutStrataCode.resetSettings.button": "Сбросить все настройки",
  "settings.aboutStrataCode.settingsTransfer.title": "Перенос настроек",
  ...
  "settings.aboutStrataCode.exportSettings": "Экспорт",
  "settings.aboutStrataCode.importSettings": "Импорт",
  "settings.aboutStrataCode.importSettings.invalidJson": "Недопустимый файл JSON. Выберите корректный файл настроек.",
  "settings.aboutStrataCode.importSettings.invalidConfig": "Файл не содержит допустимых настроек Strata.",
  "settings.aboutStrataCode.importSettings.tooLarge": "Файл слишком большой. Файлы настроек должны быть менее 1 MB.",
  "settings.aboutStrataCode.importSettings.newerVersion":
    "Этот файл был экспортирован из более новой версии Strata. Некоторые настройки могут быть проигнорированы.",
  "settings.aboutStrataCode.importSettings.success":
    "Настройки импортированы. Просмотрите изменения выше и нажмите «Сохранить».",

  "settings.aboutStrataCode.telemetry.title": "Телеметрия",
  ...
  "settings.aboutStrataCode.telemetry.openSettings": "Открыть настройки телеметрии",
  ...
  "settings.language.description": "Выберите язык интерфейса Strata Code. «Авто» использует язык отображения VS Code.",
  ...
  "settings.experimental.remote.description":
    "Включите управление Remote сеансами через Strata Cloud. Это также повлияет на CLI на этом компьютере.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Загружать инструкции CLAUDE.md и навыки из каталога конфигурации Claude Code в сессии. Включите эту опцию, если хотите, чтобы Strata использовал ваши инструкции и навыки Claude Code. Требуется перезапуск.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP-серверы не настроены. Добавьте MCP-серверы в strata.jsonc или попросите агента добавить их.",
  ...
  "settings.aboutStrataCode.legacyMigration.title": "Миграция с устаревшей версии",
  "settings.aboutStrataCode.legacyMigration.description":
    "Перенос настроек из предыдущей установки Strata Code, включая API-ключи провайдеров и модель по умолчанию.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Что нового в Strata Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Одно компактное и эффективное ядро для всех продуктов Strata. Знакомый опыт независимо от выбранного способа работы.",
