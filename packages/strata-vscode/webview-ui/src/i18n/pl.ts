export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Strata",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Strata.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Strata.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Strata.",
  ...
  "dialog.server.description": "Przełącz serwer Strata, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Strata ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Strata",
  ...
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, Strata nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "sidebar.gettingStarted.line1": "Strata zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Strata",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Strata na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Strata.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Strata",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Strata.",
  ...
  "settings.providers.betaNotice":
    "Obecnie w interfejsie ustawień można skonfigurować tylko dostawcę Strata Gateway. Obsługa konfiguracji innych dostawców pojawi się wkrótce w fazie beta. W międzyczasie możesz konfigurować dostawców za pomocą CLI lub pliku konfiguracyjnego. Zależy nam na zachowaniu otwartości Strata, bez lock-inu.",
  ...
  "settings.config.title": "Otwórz plik konfiguracyjny Strata ({{scope}})",
  "settings.config.placeholder":
    "Pliki konfiguracyjne są scalane po kolei; pliki oznaczone jako wczytane mają obecnie wpływ na ustawienia.",
  "settings.config.noWorkspace": "Otwórz folder obszaru roboczego, aby edytować lokalny plik konfiguracyjny Strata.",
  "settings.config.openFailed": "Nie udało się otworzyć pliku konfiguracyjnego Strata ({{scope}}): {{message}}",
  "settings.config.source.xdg": "Globalna konfiguracja XDG",
  "settings.config.source.homeStrata": "Konfiguracja .strata (Home)",
  "settings.config.source.homeStratacode": "Konfiguracja .stratacode (Home)",
  "settings.config.source.homeOpencode": "Konfiguracja .opencode (Home)",
  "settings.config.source.envFile": "Plik środowiskowy STRATA_CONFIG",
  "settings.config.source.envDir": "STRATA_CONFIG_DIR",
  "settings.config.source.envContent": "Wbudowana konfiguracja środowiska",
  "settings.config.source.projectStrata": "Konfiguracja .strata projektu",
  "settings.config.source.projectRoot": "Konfiguracja główna projektu",
  "settings.config.source.projectStratacode": "Przestarzała konfiguracja .stratacode",
  ...
  "session.cloud.import.placeholder": "ID sesji, URL lub polecenie strata import",
  ...
  "deviceAuth.title": "Zaloguj się do Strata Code",
  ...
  "profile.action.login": "Zaloguj się przez Strata Code",
  ...
  "settings.aboutStrataCode.title": "O Strata Code",

  "session.messages.empty": "Rozpocznij rozmowę, wpisując wiadomość poniżej.",
  "session.messages.welcome":
    "Strata Code to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutStrataCode.status.connected": "Połączono",
  "settings.aboutStrataCode.status.connecting": "Łączenie...",
  "settings.aboutStrataCode.status.disconnected": "Rozłączono",
  "settings.aboutStrataCode.status.error": "Błąd",
  "settings.aboutStrataCode.cliServer": "Serwer CLI",
  "settings.aboutStrataCode.status.label": "Status:",
  "settings.aboutStrataCode.port.label": "Port:",
  "settings.aboutStrataCode.versionInfo": "Informacje o wersji",
  "settings.aboutStrataCode.version.label": "Wersja:",
  "settings.aboutStrataCode.extensionName": "Rozszerzenie Strata Code",
  "settings.aboutStrataCode.community": "Społeczność i wsparcie",
  "settings.aboutStrataCode.feedback.prefix": "Jeśli masz pytania lub uwagi, śmiało otwórz zgłoszenie na",
  "settings.aboutStrataCode.feedback.or": "lub",
  "settings.aboutStrataCode.support.prefix":
    "W sprawach rozliczeń lub konta skontaktuj się z obsługą klienta pod adresem",
  "settings.aboutStrataCode.resetSettings.title": "Resetuj ustawienia",
  ...
  "settings.aboutStrataCode.resetSettings.button": "Resetuj wszystkie ustawienia",
  "settings.aboutStrataCode.settingsTransfer.title": "Przenoszenie ustawień",
  ...
  "settings.aboutStrataCode.exportSettings": "Eksportuj",
  "settings.aboutStrataCode.importSettings": "Importuj",
  "settings.aboutStrataCode.importSettings.invalidJson": "Nieprawidłowy plik JSON. Wybierz prawidłowy plik ustawień.",
  "settings.aboutStrataCode.importSettings.invalidConfig": "Plik nie zawiera prawidłowych ustawień Strata.",
  "settings.aboutStrataCode.importSettings.tooLarge": "Plik jest za duży. Pliki ustawień muszą mieć mniej niż 1 MB.",
  "settings.aboutStrataCode.importSettings.newerVersion":
    "Ten plik został wyeksportowany z nowszej wersji Strata. Niektóre ustawienia mogą zostać zignorowane.",
  ...
  "settings.aboutStrataCode.telemetry.openSettings": "Otwórz ustawienia telemetrii",
  ...
  "settings.language.description": 'Wybierz język interfejsu Strata Code. „Auto" używa języka wyświetlania VS Code.',
  ...
  "settings.experimental.remote.description":
    "Włącz sterowanie Remote sesjami za pośrednictwem Strata Cloud. Wpłynie to również na CLI na tej maszynie.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Wczytuje instrukcje CLAUDE.md oraz umiejętności z katalogu konfiguracyjnego Claude Code do sesji. Włącz tę opcję, jeśli chcesz, aby Strata korzystał z Twoich instrukcji i umiejętności Claude Code. Wymaga ponownego uruchomienia.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Brak skonfigurowanych serwerów MCP. Dodaj serwery MCP w strata.jsonc lub poproś agenta o ich dodanie.",
  ...
  "settings.aboutStrataCode.legacyMigration.title": "Migracja starszej wersji",
  "settings.aboutStrataCode.legacyMigration.description":
    "Migruj ustawienia z poprzedniej instalacji Strata Code, w tym klucze API dostawców i domyślny model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Co nowego w Strata Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno małe, wydajne jądro we wszystkich produktach Strata. Znajome doświadczenie niezależnie od sposobu pracy.",
