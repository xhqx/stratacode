export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Strata",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Strata.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Strata.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Strata.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Strata se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Strata ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Strata",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Strata no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Strata incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Strata",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Strata en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Strata.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Strata",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Strata.",
  ...
  "settings.providers.betaNotice":
    "Actualmente, solo el proveedor Strata Gateway se puede configurar en la interfaz de ajustes. El soporte para configurar otros proveedores llegará pronto durante el período beta. Mientras tanto, puedes configurar proveedores usando la CLI o el archivo de configuración. Estamos comprometidos a mantener Strata abierto, sin ataduras.",
  ...
  "settings.config.title": "Abrir archivo de configuración Strata {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Abre una carpeta de espacio de trabajo para editar el archivo de configuración Strata local.",
  "settings.config.openFailed": "Error al abrir el archivo de configuración Strata {{scope}}: {{message}}",
  "settings.config.source.xdg": "Configuración global XDG",
  "settings.config.source.homeStrata": "Configuración .strata de Home",
  "settings.config.source.homeStratacode": "Configuración .stratacode de Home",
  "settings.config.source.homeOpencode": "Configuración .opencode de Home",
  "settings.config.source.envFile": "Archivo de entorno STRATA_CONFIG",
  "settings.config.source.envDir": "STRATA_CONFIG_DIR",
  "settings.config.source.envContent": "Configuración de entorno en línea",
  "settings.config.source.projectStrata": "Configuración .strata del proyecto",
  "settings.config.source.projectRoot": "Configuración raíz del proyecto",
  "settings.config.source.projectStratacode": "Configuración heredada .stratacode",
  ...
  "session.cloud.import.placeholder": "ID de sesión, URL o comando strata import",
  ...
  "deviceAuth.title": "Iniciar sesión en Strata Code",
  ...
  "profile.action.login": "Iniciar sesión con Strata Code",
  ...
  "settings.aboutStrataCode.title": "Acerca de Strata Code",

  "session.messages.empty": "Inicia una conversación escribiendo un mensaje a continuación.",
  "session.messages.welcome":
    "Strata Code es un asistente de programación con IA. Pídele que cree funcionalidades, corrija errores o explique tu código.",
  ...
  "settings.aboutStrataCode.status.label": "Estado:",
  "settings.aboutStrataCode.port.label": "Puerto:",
  "settings.aboutStrataCode.versionInfo": "Información de versión",
  "settings.aboutStrataCode.version.label": "Versión:",
  "settings.aboutStrataCode.extensionName": "Extensión Strata Code",
  ...
  "settings.aboutStrataCode.resetSettings.button": "Restablecer toda la configuración",
  "settings.aboutStrataCode.settingsTransfer.title": "Transferencia de ajustes",
  ...
  "settings.aboutStrataCode.importSettings.invalidConfig": "El archivo no contiene ajustes válidos de Strata.",
  ...
  "settings.aboutStrataCode.importSettings.newerVersion":
    "Este archivo fue exportado desde una versión más reciente de Strata. Algunos ajustes podrían ignorarse.",
  ...
  "settings.aboutStrataCode.telemetry.title": "Telemetría",
  ...
  "settings.aboutStrataCode.telemetry.openSettings": "Abrir configuración de telemetría",
  ...
  "settings.language.description":
    'Elige el idioma de la interfaz de Strata Code. "Auto" utiliza el idioma de visualización de VS Code.',
  ...
  "settings.experimental.remote.description":
    "Habilite el control Remote de las sesiones a través de Strata Cloud. Esto también afectará a las CLI de este equipo.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carga las instrucciones y habilidades de CLAUDE.md desde tu directorio de configuración de Claude Code en las sesiones. Activa esta opción si quieres que Strata utilice tus instrucciones y habilidades de Claude Code. Requiere reiniciar.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No hay servidores MCP configurados. Añada servidores MCP en strata.jsonc o pida al agente que los añada.",
  ...
  "settings.session.watcherPatterns": "Patrones de ignorar del observador",
  "settings.session.watcherPatterns.description": "Patrones glob para archivos que el observador debe ignorar",
  ...
  "settings.aboutStrataCode.legacyMigration.title": "Migración heredada",
  "settings.aboutStrataCode.legacyMigration.description":
    "Migra la configuración de una instalación anterior de Strata Code, incluyendo las claves API de proveedores y el modelo predeterminado.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Novedades en Strata Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un núcleo pequeño y eficiente en todos los productos Strata. Una experiencia familiar sin importar cómo elijas trabajar.",
