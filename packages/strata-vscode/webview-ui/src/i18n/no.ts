...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Strata",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Strata.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Strata.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Strata.",
  ...
  "dialog.server.description": "Bytt hvilken Strata-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Strata ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Strata-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Strata ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Strata inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Strata",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Strata ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Strata er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Strata starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Strata.",
  ...
  "settings.providers.betaNotice":
    "For øyeblikket kan kun Strata Gateway-leverandøren konfigureres i innstillingsgrensesnittet. Støtte for konfigurering av andre leverandører kommer snart i løpet av betaperioden. I mellomtiden kan du konfigurere leverandører via CLI eller konfigurasjonsfilen. Vi er forpliktet til å holde Strata åpent, ingen lock-in.",
  ...
  "settings.config.title": "Åpne {{scope}} Strata-konfigurasjonsfil",
  "settings.config.placeholder":
    "Konfigurasjonsfiler slås sammen i rekkefølge; filer merket som lastet påvirker for øyeblikket innstillingene.",
  "settings.config.noWorkspace": "Åpne en arbeidsområdemappe for å redigere den lokale Strata-konfigurasjonsfilen.",
  "settings.config.openFailed": "Klarte ikke å åpne {{scope}} Strata-konfigurasjonsfil: {{message}}",
  "settings.config.source.xdg": "XDG global konfigurasjon",
  "settings.config.source.homeStrata": "Home .strata-konfigurasjon",
  "settings.config.source.homeStratacode": "Home .stratacode-konfigurasjon",
  "settings.config.source.homeOpencode": "Home .opencode-konfigurasjon",
  "settings.config.source.envFile": "STRATA_CONFIG miljøfil",
  "settings.config.source.envDir": "STRATA_CONFIG_DIR",
  "settings.config.source.envContent": "Innebygd miljøkonfigurasjon",
  "settings.config.source.projectStrata": "Prosjekt .strata-konfigurasjon",
  "settings.config.source.projectRoot": "Prosjektets rotkonfigurasjon",
  "settings.config.source.projectStratacode": "Eldre .stratacode-konfigurasjon",
  ...
  "session.cloud.import.placeholder": "Økt-ID, URL eller strata import-kommando",
  ...
  "deviceAuth.title": "Logg inn på Strata Code",
  ...
  "profile.action.login": "Logg inn med Strata Code",
  ...
  "settings.aboutStrataCode.title": "Om Strata Code",

  "session.messages.empty": "Start en samtale ved å skrive en melding nedenfor.",
  "session.messages.welcome":
    "Strata Code er en AI-kodingsassistent. Be den om å bygge funksjoner, fikse feil eller forklare kodebasen din.",
  ...
  "settings.aboutStrataCode.status.connected": "Tilkoblet",
  "settings.aboutStrataCode.status.connecting": "Kobler til...",
  "settings.aboutStrataCode.status.disconnected": "Frakoblet",
  "settings.aboutStrataCode.status.error": "Feil",
  ...
  "settings.aboutStrataCode.versionInfo": "Versjonsinformasjon",
  "settings.aboutStrataCode.version.label": "Versjon:",
  "settings.aboutStrataCode.extensionName": "Strata Code-utvidelse",
  "settings.aboutStrataCode.community": "Fellesskap og støtte",
  "settings.aboutStrataCode.feedback.prefix": "Hvis du har spørsmål eller tilbakemeldinger, åpne gjerne en issue på",
  "settings.aboutStrataCode.feedback.or": "eller",
  "settings.aboutStrataCode.support.prefix": "For fakturerings- eller kontospørsmål, kontakt kundestøtte på",
  "settings.aboutStrataCode.resetSettings.title": "Tilbakestill innstillinger",
  ...
  "settings.aboutStrataCode.resetSettings.button": "Tilbakestill alle innstillinger",
  "settings.aboutStrataCode.settingsTransfer.title": "Overføring av innstillinger",
  ...
  "settings.aboutStrataCode.exportSettings": "Eksporter",
  "settings.aboutStrataCode.importSettings": "Importer",
  "settings.aboutStrataCode.importSettings.invalidJson": "Ugyldig JSON-fil. Vennligst velg en gyldig innstillingsfil.",
  "settings.aboutStrataCode.importSettings.invalidConfig": "Filen inneholder ikke gyldige Strata-innstillinger.",
  "settings.aboutStrataCode.importSettings.tooLarge": "Filen er for stor. Innstillingsfiler må være under 1 MB.",
  "settings.aboutStrataCode.importSettings.newerVersion":
    "Denne filen ble eksportert fra en nyere versjon av Strata. Noen innstillinger kan bli ignorert.",
  ...
  "settings.aboutStrataCode.telemetry.title": "Telemetri",
  ...
  "settings.aboutStrataCode.telemetry.openSettings": "Åpne innstillinger for telemetri",
  ...
  "settings.language.description": 'Velg språket for Strata Code-grensesnittet. "Auto" bruker VS Codes visningsspråk.',
  ...
  "settings.experimental.remote.description":
    "Aktiver Remote-kontroll av økter via Strata Cloud. Dette vil også påvirke CLI-er på denne maskinen.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Last inn CLAUDE.md-instruksjoner og ferdigheter fra Claude Code-konfigurasjonsmappen din i økter. Aktiver dette hvis du vil at Strata skal bruke dine Claude Code-instruksjoner og ferdigheter. Krever omstart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigurert. Legg til MCP-servere i strata.jsonc, eller be agenten om å legge dem til.",
  ...
  "settings.aboutStrataCode.legacyMigration.title": "Migrering fra eldre versjon",
  "settings.aboutStrataCode.legacyMigration.description":
    "Migrer innstillinger fra en tidligere installasjon av Strata Code, inkludert API-nøkler for leverandører og standardmodell.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Hva er nytt i Strata Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én liten, effektiv kjerne på tvers av alle Strata-produkter. En kjent opplevelse uansett hvordan du velger å jobbe.",
