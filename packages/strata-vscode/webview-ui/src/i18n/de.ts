...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Strata",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Strata zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Strata zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Strata zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Strata-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Strata ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Strata-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Strata unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Strata enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Strata ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Strata auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Strata anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Strata automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Strata.",
  ...
  "settings.config.title": "{{scope}} Strata-Konfigurationsdatei öffnen",
  ...
  "settings.config.noWorkspace":
    "Öffnen Sie einen Arbeitsbereichsordner, um die lokale Strata-Konfigurationsdatei zu bearbeiten.",
  "settings.config.openFailed": "Fehler beim Öffnen der {{scope}} Strata-Konfigurationsdatei: {{message}}",
  "settings.config.source.xdg": "Globale XDG-Konfiguration",
  "settings.config.source.homeStrata": "Home .strata-Konfiguration",
  "settings.config.source.homeStratacode": "Home .stratacode-Konfiguration",
  "settings.config.source.homeOpencode": "Home .opencode-Konfiguration",
  "settings.config.source.envFile": "STRATA_CONFIG Umgebungsdatei",
  "settings.config.source.envDir": "STRATA_CONFIG_DIR",
  "settings.config.source.envContent": "Inline-Umgebungskonfiguration",
  "settings.config.source.projectStrata": "Projekt .strata-Konfiguration",
  "settings.config.source.projectRoot": "Projektstamm-Konfiguration",
  "settings.config.source.projectStratacode": "Veraltete .stratacode-Konfiguration",
  ...
  "session.cloud.import.placeholder": "Sitzungs-ID, URL oder strata import-Befehl",
  ...
  "deviceAuth.title": "Bei Strata Code anmelden",
  ...
  "profile.action.login": "Mit Strata Code anmelden",
  ...
  "settings.session.title": "Kontext",

  "settings.experimental.title": "Experimentell",
  "settings.language.title": "Sprache",
  "settings.aboutStrataCode.title": "Über Strata Code",

  "session.messages.empty": "Starten Sie eine Unterhaltung, indem Sie unten eine Nachricht eingeben.",
  "session.messages.welcome":
    "Strata Code ist ein KI-Programmierassistent. Bitten Sie ihn, Funktionen zu erstellen, Fehler zu beheben oder Ihre Codebasis zu erklären.",
  ...
  "settings.aboutStrataCode.status.connected": "Verbunden",
  "settings.aboutStrataCode.status.connecting": "Verbindung wird hergestellt...",
  "settings.aboutStrataCode.status.disconnected": "Getrennt",
  "settings.aboutStrataCode.status.error": "Fehler",
  ...
  "settings.aboutStrataCode.versionInfo": "Versionsinformationen",
  "settings.aboutStrataCode.version.label": "Version:",
  "settings.aboutStrataCode.extensionName": "Strata Code Erweiterung",
  "settings.aboutStrataCode.community": "Community & Support",
  "settings.aboutStrataCode.feedback.prefix": "Bei Fragen oder Feedback können Sie ein Issue eröffnen auf",
  "settings.aboutStrataCode.feedback.or": "oder",
  "settings.aboutStrataCode.support.prefix":
    "Bei Abrechnungs- oder Kontofragen wenden Sie sich an den Kundensupport unter",
  "settings.aboutStrataCode.resetSettings.title": "Einstellungen zurücksetzen",
  ...
  "settings.aboutStrataCode.resetSettings.button": "Alle Einstellungen zurücksetzen",
  "settings.aboutStrataCode.settingsTransfer.title": "Einstellungen übertragen",
  ...
  "settings.aboutStrataCode.exportSettings": "Exportieren",
  "settings.aboutStrataCode.importSettings": "Importieren",
  ...
  "settings.aboutStrataCode.importSettings.invalidConfig": "Die Datei enthält keine gültigen Strata-Einstellungen.",
  ...
  "settings.aboutStrataCode.importSettings.newerVersion":
    "Diese Datei wurde mit einer neueren Version von Strata exportiert. Einige Einstellungen werden möglicherweise ignoriert.",
  ...
  "settings.aboutStrataCode.telemetry.title": "Telemetrie",
  ...
  "settings.aboutStrataCode.telemetry.openSettings": "Telemetrie-Einstellungen öffnen",
  ...
  "settings.language.description":
    'Wählen Sie die Sprache für die Strata Code Oberfläche. „Auto" verwendet die VS Code Anzeigesprache.',
  ...
  "settings.experimental.remote.description":
    "Aktivieren Sie die Remote-Steuerung von Sitzungen über Strata Cloud. Dies betrifft auch CLIs auf diesem Computer.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Lädt CLAUDE.md-Anweisungen und Skills aus Ihrem Claude Code-Konfigurationsverzeichnis in Sitzungen. Aktivieren Sie dies, wenn Strata Ihre Claude Code-Anweisungen und Skills verwenden soll. Neustart erforderlich.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Keine MCP-Server konfiguriert. Fügen Sie MCP-Server in strata.jsonc hinzu oder bitten Sie den Agenten, sie hinzuzufügen.",
  ...
  "settings.session.watcherPatterns": "Datei-Watcher-Ignorierungsmuster",
  "settings.session.watcherPatterns.description": "Glob-Muster für Dateien, die der Watcher ignorieren soll",
  ...
  "settings.aboutStrataCode.legacyMigration.description":
    "Migrieren Sie Einstellungen von einer früheren Installation von Strata Code, einschließlich Anbieter-API-Schlüsseln und dem Standardmodell.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Neuigkeiten in Strata Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Ein kleiner, effizienter Kern über alle Strata-Produkte hinweg. Ein vertrautes Erlebnis, egal wie Sie arbeiten.",
