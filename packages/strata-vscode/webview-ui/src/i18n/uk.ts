export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Strata",
  ...
  "provider.connect.apiKey.description":
    "Введіть свій API-ключ {{provider}}, щоб підключити акаунт {{provider}} і використовувати моделі {{provider}} в Strata.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " щоб отримати код авторизації для підключення акаунта та використання моделей {{provider}} у Strata.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " та введіть код нижче, щоб підключити акаунт і використовувати моделі {{provider}} у Strata.",
  ...
  "dialog.server.description": "Змінити, до якого сервера Strata підключається цей додаток.",
  ...
  "toast.update.description": "Нова версія Strata ({{version}}) готова до встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Strata",
  ...
  "sidebar.gettingStarted.line1": "Strata включає безкоштовні моделі, тому ви можете почати відразу.",
  ...
  "settings.general.row.language.description": "Змінити мову відображення Strata",
  "settings.general.row.appearance.title": "Вигляд",
  "settings.general.row.appearance.description": "Налаштувати вигляд Strata на вашому пристрої",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштувати тему Strata.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти оновлення при запуску Strata",
  ...
  "settings.updates.toast.latest.description": "У вас встановлена остання версія Strata.",
  ...
  "settings.providers.betaNotice":
    "Наразі в інтерфейсі налаштувань можна налаштувати лише провайдера Strata Gateway. Підтримка інших провайдерів з'явиться в бета-версії найближчим часом. Тим часом ви можете налаштовувати провайдерів через CLI або файл конфігурації. Strata залишається відкритим — без прив'язки.",
  ...
  "settings.config.source.homeStratacode": "Конфігурація .stratacode (Home)",
  "settings.config.source.homeOpencode": "Конфігурація .opencode (Home)",
  "settings.config.source.envFile": "Файл середовища STRATA_CONFIG",
  "settings.config.source.envDir": "STRATA_CONFIG_DIR",
  "settings.config.source.envContent": "Вбудована конфігурація середовища",
  "settings.config.source.projectStrata": "Конфігурація .strata проєкту",
  "settings.config.source.projectRoot": "Коренева конфігурація проєкту",
  "settings.config.source.projectStratacode": "Застаріла конфігурація .stratacode",
  ...
  "session.cloud.import.placeholder": "Ідентифікатор сесії, URL або команда strata import",
  ...
  "deviceAuth.title": "Увійти до Strata Code",
  ...
  "profile.action.login": "Увійти через Strata Code",
  ...
  "settings.aboutStrataCode.title": "Про Strata Code",

  "session.messages.empty": "Напишіть повідомлення нижче, щоб розпочати чат.",
  "session.messages.welcome":
    "Strata Code — це асистент з кодування на базі ШІ. Попросіть його розробити функцію, виправити помилку або пояснити вашу кодову базу.",
  ...
  "settings.aboutStrataCode.status.connected": "Підключено",
  "settings.aboutStrataCode.status.connecting": "Підключення...",
  "settings.aboutStrataCode.status.disconnected": "Відключено",
  "settings.aboutStrataCode.status.error": "Помилка",
  ...
  "settings.aboutStrataCode.versionInfo": "Інформація про версію",
  "settings.aboutStrataCode.version.label": "Версія:",
  "settings.aboutStrataCode.extensionName": "Розширення Strata Code",
  ...
  "settings.aboutStrataCode.resetSettings.button": "Скинути всі налаштування",
  "settings.aboutStrataCode.settingsTransfer.title": "Перенесення налаштувань",
  ...
  "settings.aboutStrataCode.exportSettings": "Експортувати",
  "settings.aboutStrataCode.importSettings": "Імпортувати",
  "settings.aboutStrataCode.importSettings.invalidJson":
    "Недійсний файл JSON. Будь ласка, виберіть дійсний файл налаштувань.",
  "settings.aboutStrataCode.importSettings.invalidConfig": "Файл не містить дійсних налаштувань Strata.",
  "settings.aboutStrataCode.importSettings.tooLarge": "Файл занадто великий. Файли налаштувань мають бути менше 1 МБ.",
  "settings.aboutStrataCode.importSettings.newerVersion":
    "Цей файл було експортовано з новішої версії Strata. Деякі налаштування можуть бути проігноровані.",
  "settings.aboutStrataCode.importSettings.success":
    "Налаштування імпортовано. Перегляньте зміни вище, потім натисніть Зберегти.",

  "settings.aboutStrataCode.telemetry.title": "Телеметрія",
  ...
  "settings.aboutStrataCode.telemetry.openSettings": "Відкрити налаштування телеметрії",
  ...
  "settings.language.description":
    '"Автоматично" використовує мову відображення VS Code. Виберіть мову для інтерфейсу Strata Code.',
  ...
  "settings.experimental.remote.description":
    "Увімкніть керування Remote сеансами через Strata Cloud. Це також вплине на CLI на цьому комп'ютері.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Завантажувати інструкції та навички CLAUDE.md з вашого каталогу конфігурації Claude Code у сесії. Увімкніть це, якщо ви хочете, щоб Strata використовував ваші інструкції та навички Claude Code. Потребує перезапуску.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP-серверів не налаштовано. Додайте MCP-сервери до strata.jsonc або попросіть агента додати їх.",
  ...
  "settings.session.watcherPatterns": "Шаблони ігнорування спостерігача файлів",
  "settings.session.watcherPatterns.description": "Glob-шаблони для файлів, які спостерігач має ігнорувати",
  ...
  "settings.aboutStrataCode.legacyMigration.title": "Перенесення зі старої версії",
  "settings.aboutStrataCode.legacyMigration.description":
    "Перенести налаштування з попередньої версії Strata Code, включаючи API-ключі провайдерів та стандартну модель.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Що нового в Strata Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Малий та ефективний ядерний модуль у кожному продукті Strata. Знайомий досвід незалежно від того, як ви вважаєте за краще працювати.",
