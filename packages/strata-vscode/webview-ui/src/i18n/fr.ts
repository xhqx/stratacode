export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Strata",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Strata.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Strata.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Strata.",
  ...
  "dialog.server.description": "Changez le serveur Strata auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Strata ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Strata",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Strata ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "Strata inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Strata",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Strata sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Strata.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Strata",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Strata.",
  ...
  "settings.providers.betaNotice":
    "Actuellement, seul le fournisseur Strata Gateway peut être configuré dans l'interface des paramètres. La prise en charge de la configuration d'autres fournisseurs sera bientôt disponible pendant la période bêta. En attendant, vous pouvez configurer les fournisseurs à l'aide de la CLI ou du fichier de configuration. Nous nous engageons à maintenir Strata ouvert, sans enfermement propriétaire.",
  ...
  "settings.config.title": "Ouvrir le fichier de configuration Strata {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Ouvrez un dossier d'espace de travail pour modifier le fichier de configuration Strata local.",
  "settings.config.openFailed": "Échec de l'ouverture du fichier de configuration Strata {{scope}} : {{message}}",
  "settings.config.source.xdg": "Configuration globale XDG",
  "settings.config.source.homeStrata": "Configuration .strata de Home",
  "settings.config.source.homeStratacode": "Configuration .stratacode de Home",
  "settings.config.source.homeOpencode": "Configuration .opencode de Home",
  "settings.config.source.envFile": "Fichier d'environnement STRATA_CONFIG",
  "settings.config.source.envDir": "STRATA_CONFIG_DIR",
  "settings.config.source.envContent": "Configuration d'environnement en ligne",
  "settings.config.source.projectStrata": "Configuration .strata du projet",
  "settings.config.source.projectRoot": "Configuration racine du projet",
  "settings.config.source.projectStratacode": "Configuration obsolète .stratacode",
  ...
  "session.cloud.import.placeholder": "ID de session, URL ou commande strata import",
  ...
  "deviceAuth.title": "Se connecter à Strata Code",
  ...
  "profile.action.login": "Se connecter avec Strata Code",
  ...
  "settings.session.title": "Contexte",

  "settings.experimental.title": "Expérimental",
  "settings.language.title": "Langue",
  "settings.aboutStrataCode.title": "À propos de Strata Code",

  "session.messages.empty": "Commencez une conversation en tapant un message ci-dessous.",
  "session.messages.welcome":
    "Strata Code est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.aboutStrataCode.status.connected": "Connecté",
  "settings.aboutStrataCode.status.connecting": "Connexion en cours...",
  "settings.aboutStrataCode.status.disconnected": "Déconnecté",
  "settings.aboutStrataCode.status.error": "Erreur",
  "settings.aboutStrataCode.cliServer": "Serveur CLI",
  "settings.aboutStrataCode.status.label": "Statut :",
  "settings.aboutStrataCode.port.label": "Port :",
  "settings.aboutStrataCode.versionInfo": "Informations de version",
  "settings.aboutStrataCode.version.label": "Version :",
  "settings.aboutStrataCode.extensionName": "Extension Strata Code",
  "settings.aboutStrataCode.community": "Communauté et support",
  ...
  "settings.aboutStrataCode.resetSettings.button": "Réinitialiser tous les paramètres",
  "settings.aboutStrataCode.settingsTransfer.title": "Transfert des paramètres",
  ...
  "settings.aboutStrataCode.exportSettings": "Exporter",
  "settings.aboutStrataCode.importSettings": "Importer",
  ...
  "settings.aboutStrataCode.importSettings.invalidConfig": "Le fichier ne contient pas de paramètres Strata valides.",
  ...
  "settings.aboutStrataCode.importSettings.newerVersion":
    "Ce fichier a été exporté depuis une version plus récente de Strata. Certains paramètres pourraient être ignorés.",
  ...
  "settings.aboutStrataCode.telemetry.title": "Télémétrie",
  ...
  "settings.aboutStrataCode.telemetry.openSettings": "Ouvrir les paramètres de télémétrie",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de Strata Code. \"Auto\" utilise la langue d'affichage de VS Code.",
  ...
  "settings.experimental.remote.description":
    "Activez le contrôle Remote des sessions via Strata Cloud. Cela affectera également les CLI sur cette machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Charge les instructions et les compétences de CLAUDE.md depuis votre répertoire de configuration Claude Code dans les sessions. Activez cette option si vous souhaitez que Strata utilise vos instructions et compétences Claude Code. Nécessite un redémarrage.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Aucun serveur MCP configuré. Ajoutez des serveurs MCP dans strata.jsonc ou demandez à l'agent de les ajouter.",
  ...
  "settings.session.watcherPatterns": "Motifs d'ignorance de l'observateur",
  "settings.session.watcherPatterns.description": "Motifs glob pour les fichiers que l'observateur doit ignorer",
  ...
  "settings.aboutStrataCode.legacyMigration.title": "Migration de l'ancienne version",
  "settings.aboutStrataCode.legacyMigration.description":
    "Migrer les paramètres d'une précédente installation de Strata Code, y compris les clés d'API des fournisseurs et le modèle par défaut.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nouveautés de Strata Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un noyau petit et efficace partagé par tous les produits Strata. Une expérience familière quelle que soit votre façon de travailler.",
