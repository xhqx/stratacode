export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Strata",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Strata.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Strata.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Strata.",
  ...
  "dialog.server.description": "Switch which Strata server this app connects to.",
  ...
  "toast.update.description": "A new version of Strata ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Strata team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Strata does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Strata includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for Strata",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Strata looks on your device",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Strata launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Strata.",
  ...
  "settings.providers.betaNotice":
    "Currently only the Strata Gateway provider can be configured in the settings interface. Support for configuring other providers is coming soon during the beta period. In the interim you can configure providers using the CLI or config file. We're committed to keeping Strata open, no lock-in.",
  ...
  "settings.config.title": "Open {{scope}} Strata config file",
  "settings.config.placeholder": "Config files are merged in order; files marked loaded currently affect settings.",
  "settings.config.noWorkspace": "Open a workspace folder to edit the local Strata config file.",
  "settings.config.openFailed": "Failed to open {{scope}} Strata config file: {{message}}",
  "settings.config.source.xdg": "XDG global config",
  "settings.config.source.homeStrata": "Home .strata config",
  "settings.config.source.homeStratacode": "Home .stratacode config",
  "settings.config.source.homeOpencode": "Home .opencode config",
  "settings.config.source.envFile": "STRATA_CONFIG environment file",
  "settings.config.source.envDir": "STRATA_CONFIG_DIR",
  "settings.config.source.envContent": "Inline environment config",
  "settings.config.source.projectStrata": "Project .strata config",
  "settings.config.source.projectRoot": "Project root config",
  "settings.config.source.projectStratacode": "Legacy .stratacode config",
  ...
  "session.cloud.import.placeholder": "Session ID, URL, or strata import command",
  ...
  "deviceAuth.title": "Sign in to Strata Code",
  ...
  "profile.action.login": "Login with Strata Code",
  ...
  "settings.agentBehaviour.title": "Session",
  "settings.agentBehaviour.permissions.resetAll": "Reset All to Default",
  "settings.agentBehaviour.importOpenCodeSettings": "Import OpenCode Settings",
  "settings.agentBehaviour.formatter.title": "Formatter",
  "settings.agentBehaviour.formatter.description": "Configure the automatic code formatter settings.",
  "settings.agentBehaviour.subtab.globals": "Globals",
  "settings.autoApprove.title": "Permissions",
  "settings.browser.title": "Browser",
  "settings.checkpoints.title": "Checkpoints",
  "settings.retries.enabled.title": "Enable Retries",
  "settings.retries.enabled.description": "Automatically retry failed requests.",
  "settings.retries.limit.title": "Retry Limit",
  "settings.retries.limit.description": "Maximum number of retry attempts.",
  "settings.retries.delay.title": "Retry Delay",
  "settings.retries.delay.description": "Initial delay between retries in milliseconds.",
  "settings.retries.maxDelay.title": "Max Retry Delay",
  "settings.retries.maxDelay.description": "Maximum delay between retries in milliseconds.",
  ...
  "session.messages.welcome":
    "Strata Code is an AI coding assistant. Ask it to build features, fix bugs, or explain your codebase.",
  ...
  "settings.aboutStrataCode.status.connected": "Connected",
  "settings.aboutStrataCode.status.connecting": "Connecting...",
  "settings.aboutStrataCode.status.disconnected": "Disconnected",
  "settings.aboutStrataCode.status.error": "Error",
  "settings.aboutStrataCode.cliServer": "CLI Server",
  "settings.aboutStrataCode.status.label": "Status:",
  "settings.aboutStrataCode.port.label": "Port:",
  "settings.aboutStrataCode.versionInfo": "Version Information",
  "settings.aboutStrataCode.version.label": "Version:",
  "settings.aboutStrataCode.extensionName": "Strata Code Extension",
  "settings.aboutStrataCode.community": "Community & Support",
  "settings.aboutStrataCode.feedback.prefix": "If you have any questions or feedback, feel free to open an issue on",
  "settings.aboutStrataCode.feedback.or": "or",
  "settings.aboutStrataCode.support.prefix": "For billing or account questions, contact Customer Support at",
  "settings.aboutStrataCode.resetSettings.title": "Reset Settings",
  ...
  "settings.aboutStrataCode.resetSettings.button": "Reset All Settings",
  "settings.aboutStrataCode.settingsTransfer.title": "Settings Transfer",
  "settings.aboutStrataCode.settingsTransfer.description":
    "Export or import your settings to transfer them between VS Code instances.",
  "settings.aboutStrataCode.exportSettings": "Export",
  "settings.aboutStrataCode.importSettings": "Import",
  "settings.aboutStrataCode.importSettings.invalidJson": "Invalid JSON file. Please select a valid settings file.",
  "settings.aboutStrataCode.importSettings.invalidConfig": "File does not contain valid Strata settings.",
  "settings.aboutStrataCode.importSettings.tooLarge": "File is too large. Settings files must be under 1 MB.",
  "settings.aboutStrataCode.importSettings.newerVersion":
    "This file was exported from a newer version of Strata. Some settings may be ignored.",
  "settings.aboutStrataCode.importSettings.success": "Settings imported. Review the changes above, then click Save.",

  "settings.aboutStrataCode.telemetry.title": "Telemetry",
  "settings.aboutStrataCode.telemetry.description":
  ...
  "settings.agentBehaviour.subtab.autoApprove": "Permissions",
  "settings.agentBehaviour.subtab.session": "Context",
  ...
  "settings.language.description":
    'Choose the language for the Strata Code UI. "Auto" uses your VS Code display language.',
  ...
  "settings.autocomplete.showAgent.description":
    "Add the Autocomplete agent to the global Agents dropdown in the chat header.",
  ...
  "settings.experimental.batchTool.description": "Enable batching of multiple tool calls",
  ...
  "settings.experimental.remote.description":
    "Enable remote control of sessions via Strata Cloud. This will also affect CLIs on this machine.",
  ...
  "settings.agentBehaviour.retry.title": "Auto-Retry",
  "settings.agentBehaviour.retry.description": "Configure agent retry behavior on failure.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Load CLAUDE.md instructions and skills from your Claude Code configuration directory into sessions. Enable this if you want Strata to use your Claude Code instructions and skills. Requires restart.",
  ...
  "settings.agentBehaviour.acpDetail.args": "Arguments",
  ...
  // MCP create
  "settings.agentBehaviour.addMcpServer": "Add Server",
  "settings.agentBehaviour.mcpCreate": "Create MCP Server",
  "settings.agentBehaviour.mcpCreate.name": "Server Name",
  "settings.agentBehaviour.mcpCreate.name.description": "A unique identifier for this MCP server.",
  "settings.agentBehaviour.mcpCreate.name.placeholder": "my-server",
  "settings.agentBehaviour.mcpCreate.name.required": "Name is required",
  "settings.agentBehaviour.mcpCreate.name.invalid":
    "Name must start with a lowercase letter and contain only lowercase letters, numbers, and hyphens",
  "settings.agentBehaviour.mcpCreate.name.taken": "A server with this name already exists",
  "settings.agentBehaviour.mcpCreate.transport": "Transport",
  "settings.agentBehaviour.mcpCreate.transportLocal": "Local (stdio)",
  ...
  "settings.agentBehaviour.acpCreate.button": "Create",

  // Workflow CRUD
  "settings.agentBehaviour.addWorkflow": "Add Workflow",
  "settings.agentBehaviour.editWorkflow": "Edit Workflow",
  "settings.agentBehaviour.createWorkflow": "Create Workflow",
  "settings.agentBehaviour.removeWorkflow.title": "Remove Workflow",
  "settings.agentBehaviour.removeWorkflow.confirm": 'Remove workflow "{{name}}"?',
  "settings.agentBehaviour.removeWorkflow.button": "Remove",
  "settings.agentBehaviour.workflow.name": "Name",
  "settings.agentBehaviour.workflow.name.description": "Slash command name (e.g. deploy)",
  "settings.agentBehaviour.workflow.name.placeholder": "my-workflow",
  "settings.agentBehaviour.workflow.name.required": "Name is required",
  "settings.agentBehaviour.workflow.name.invalid":
    "Name must start with a lowercase letter and contain only lowercase letters, numbers, and hyphens",
  "settings.agentBehaviour.workflow.name.taken": "A workflow with this name already exists",
  "settings.agentBehaviour.workflow.description": "Description",
  "settings.agentBehaviour.workflow.description.placeholder": "What this workflow does",
  "settings.agentBehaviour.workflow.template": "Template",
  "settings.agentBehaviour.workflow.template.placeholder": "Prompt template with {{args}} placeholders",
  "settings.agentBehaviour.workflow.template.required": "Template is required",
  "settings.agentBehaviour.workflow.agent": "Agent Override",
  "settings.agentBehaviour.workflow.agent.placeholder": "Leave empty for default",
  "settings.agentBehaviour.workflow.model": "Model Override",
  "settings.agentBehaviour.workflow.model.placeholder": "e.g. anthropic/claude-sonnet-4",
  "settings.agentBehaviour.workflow.subtask": "Run as Subtask",
  "settings.agentBehaviour.workflow.subtask.description": "When enabled, runs in a sub-agent context",
  "settings.agentBehaviour.workflow.create": "Create",
  "settings.agentBehaviour.workflow.save": "Save",
  "settings.agentBehaviour.workflow.cancel": "Cancel",
  "settings.agentBehaviour.workflow.fileBacked": "File-backed (read-only)",

  // Inline edit validation
  "settings.agentBehaviour.inlineEdit.empty": "Value cannot be empty",
  "settings.agentBehaviour.inlineEdit.duplicate": "This value already exists",
  ...
  "settings.agentBehaviour.editMode.tab.general": "General",
  "settings.agentBehaviour.editMode.tab.prompt": "Prompt",
  "settings.agentBehaviour.editMode.tab.permissions": "Permissions",
  "settings.agentBehaviour.editMode.tab.features": "Agent-Specific",
  ...
  "permission.countdown": "Auto-approving in {{seconds}}s...",
  "permission.countdown.cancel": "Cancel auto-approve",
  "question.countdown": "Auto-selecting in {{seconds}}s...",
  "settings.autoApprove.timer.title": "Auto-Approve Timer",
  "settings.autoApprove.timer.permission": "Permission timeout (seconds)",
  "settings.autoApprove.timer.question": "Question timeout (seconds)",
  "settings.autoApprove.timer.disabled": "Disabled (0)",
  "settings.autoApprove.timer.warning": "Auto-approving bypasses manual review. Use with caution.",
  "settings.agent.permissions.title": "Agent Permissions",
  ...
  "settings.context.compactionThreshold.description":
    "Trigger auto-compaction when context reaches this percentage of the model's maximum context window (10–100%, default: 100%)",
  "settings.session.watcherPatterns": "File Watcher Ignore Patterns",
  "settings.session.watcherPatterns.description": "Glob patterns for files the watcher should ignore",
  ...
  "settings.commitMessage.model.description":
    "Model used to generate commit messages. If not set, falls back to the default small model.",
  ...
  "settings.aboutStrataCode.legacyMigration.title": "Legacy Migration",
  "settings.aboutStrataCode.legacyMigration.description":
    "Migrate settings from a previous installation of Strata Code, including provider API keys and default model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "What's New in Strata Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "One small, efficient core across every Strata product. A familiar experience however you choose to work.",
  ...
  "kanban.columns.progress": "In Progress",
  "kanban.columns.needsAction": "Needs Action",
  "kanban.columns.done": "Done",
  "kanban.empty": "No tasks",
  "kanban.placeholder.title": "Task title…",
  "kanban.placeholder.description": "Description (optional)…",
  "kanban.source.agent": "AI",
  "kanban.source.manual": "Manual",
  "kanban.delete": "Delete",
  "kanban.goToSession": "Go to session",
  "kanban.moveTo": "Move to…",
  "kanban.layout.vertical": "Switch to Vertical Layout",
  "kanban.layout.horizontal": "Switch to Horizontal Layout",
  ...
  "planning.list": "List",
  "planning.addTask": "Add Planned Task",
  "planning.editTask": "Edit Task",
  "planning.startAt": "Start Time",
  "planning.deadline": "Deadline",
  "planning.duration": "Duration (minutes)",
  "planning.dependsOn": "Depends On",
  "planning.prompt": "Agent Prompt",
  "planning.agent": "Agent",
  "planning.model": "Model",
  "planning.priority": "Priority",
  "planning.priority.1": "Critical",
  "planning.priority.2": "High",
  "planning.priority.3": "Normal",
  "planning.priority.4": "Low",
  "planning.priority.5": "Minimal",
  "planning.unscheduled": "Unscheduled",
  "planning.status.planned": "Planned",
  "planning.status.ready": "Ready",
  "planning.status.dispatched": "Running",
  "planning.status.needs_review": "Needs Review",
  "planning.status.done": "Done",
  "planning.status.failed": "Failed",
  "planning.noTasks": "No planned tasks yet",
  "planning.dispatch": "Start Now",
  "planning.confirm": "Mark Done",
  "planning.retry": "Retry",
  "planning.cycleDetected": "This would create a circular dependency",
  "planning.goToSession": "Go to Session",
  "planning.dispatchSuccess": "Task dispatched successfully",
  "planning.dispatchError": "Failed to dispatch task",
