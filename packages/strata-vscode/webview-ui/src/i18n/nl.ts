export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Voer uw {{provider}} API-sleutel in om uw account te verbinden en {{provider}} modellen te gebruiken in Strata.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om uw autorisatiecode op te halen waarmee u uw account kunt verbinden en {{provider}} modellen kunt gebruiken in Strata.",
  ...
  "dialog.server.description": "Wissel met welke Strata-server deze app verbinding maakt.",
  ...
  "error.page.report.prefix": "Meld deze fout alsjeblieft aan het Strata team",
  ...
  "sidebar.gettingStarted.line1": "Strata bevat gratis modellen, zodat je meteen kunt beginnen.",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Strata eruitziet op je apparaat",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Strata start",
  ...
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Strata.",
  ...
  "settings.providers.betaNotice":
    "Momenteel kan alleen de Strata Gateway-provider worden geconfigureerd in de instellingeninterface. Ondersteuning voor het configureren van andere providers komt binnenkort tijdens de bèta-periode. In de tussentijd kun je providers configureren met behulp van de CLI of het configuratiebestand. We zijn toegewijd om Strata open te houden, geen lock-in.",
  ...
  "settings.config.title": "Open {{scope}} Strata-configuratiebestand",
  ...
  "settings.config.noWorkspace": "Open een werkruimtemap om het lokale Strata-configuratiebestand te bewerken.",
  "settings.config.openFailed": "Kan {{scope}} Strata-configuratiebestand niet openen: {{message}}",
  "settings.config.source.xdg": "XDG globale configuratie",
  "settings.config.source.homeStrata": "Home .strata-configuratie",
  "settings.config.source.homeStratacode": "Home .stratacode-configuratie",
  "settings.config.source.homeOpencode": "Home .opencode-configuratie",
  "settings.config.source.envFile": "STRATA_CONFIG omgevingsbestand",
  "settings.config.source.envDir": "STRATA_CONFIG_DIR",
  "settings.config.source.envContent": "Inline omgevingsconfiguratie",
  "settings.config.source.projectStrata": "Project .strata-configuratie",
  "settings.config.source.projectRoot": "Project root configuratie",
  "settings.config.source.projectStratacode": "Verouderde .stratacode-configuratie",
  ...
  "session.cloud.import.placeholder": "Sessie-ID, URL, of strata import commando",
  ...
  "deviceAuth.title": "Meld je aan bij Strata Code",
  ...
  "profile.action.login": "Inloggen met Strata Code",
  ...
  "settings.session.title": "Context",
  ...
  "settings.aboutStrataCode.title": "Over Strata Code",

  "session.messages.empty": "Start een gesprek door hieronder een bericht te typen.",
  "session.messages.welcome":
    "Strata Code is een AI-codeerassistent. Vraag het om features te bouwen, bugs op te lossen of je codebase uit te leggen.",
  ...
  "settings.aboutStrataCode.status.connected": "Verbonden",
  "settings.aboutStrataCode.status.connecting": "Verbinden...",
  "settings.aboutStrataCode.status.disconnected": "Verbinding verbroken",
  "settings.aboutStrataCode.status.error": "Fout",
  "settings.aboutStrataCode.cliServer": "CLI Server",
  "settings.aboutStrataCode.status.label": "Status:",
  "settings.aboutStrataCode.port.label": "Poort:",
  "settings.aboutStrataCode.versionInfo": "Versie-informatie",
  ...
  "settings.aboutStrataCode.resetSettings.title": "Instellingen resetten",
  ...
  "settings.aboutStrataCode.resetSettings.button": "Alle instellingen resetten",
  "settings.aboutStrataCode.settingsTransfer.title": "Instellingen overdragen",
  ...
  "settings.aboutStrataCode.exportSettings": "Exporteren",
  "settings.aboutStrataCode.importSettings": "Importeren",
  "settings.aboutStrataCode.importSettings.invalidJson":
    "Ongeldig JSON-bestand. Selecteer een geldig instellingenbestand.",
  "settings.aboutStrataCode.importSettings.invalidConfig": "Het bestand bevat geen geldige Strata-instellingen.",
  ...
  "settings.aboutStrataCode.importSettings.newerVersion":
    "Dit bestand is geëxporteerd vanuit een nieuwere versie van Strata. Sommige instellingen worden mogelijk genegeerd.",
  ...
  "settings.aboutStrataCode.telemetry.openSettings": "Telemetrie-instellingen openen",
  ...
  "settings.language.description": 'Kies de taal voor de Strata Code UI. "Auto" gebruikt je VS Code schermtaal.',
  ...
  "settings.experimental.remote.description":
    "Schakel Remote-bediening van sessies in via Strata Cloud. Dit heeft ook invloed op CLI's op deze machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Laad CLAUDE.md instructies en vaardigheden uit je Claude Code configuratiemap in sessies. Schakel dit in als je wilt dat Strata je Claude Code instructies en vaardigheden gebruikt. Herstart vereist.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Geen MCP-servers geconfigureerd. Voeg MCP-servers toe in strata.jsonc of vraag de agent om ze toe te voegen.",
  ...
  "settings.session.watcherPatterns": "File Watcher Negeer Patronen",
  "settings.session.watcherPatterns.description": "Glob-patronen voor bestanden die de watcher moet negeren",
  ...
  "settings.aboutStrataCode.legacyMigration.title": "Legacy Migratie",
  "settings.aboutStrataCode.legacyMigration.description":
    "Migreer instellingen van een eerdere installatie van Strata Code, inclusief provider API-sleutels en standaard model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Wat is er Nieuw in Strata Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Één kleine, efficiënte kern voor elk Strata-product. Een vertrouwde ervaring, hoe je ook wilt werken.",
