export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Strata",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Strata",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Strata",
  ...
  "provider.connect.oauth.auto.visit.suffix": " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Strata",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Strata ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Strata ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Strata",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Strata ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "Strata รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Strata",
  "settings.general.row.appearance.title": "รูปลักษณ์",
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ Strata มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ Strata มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Strata เปิดตัว",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้ Strata เวอร์ชันล่าสุด",
  ...
  "settings.providers.betaNotice":
    "ปัจจุบันสามารถตั้งค่าได้เฉพาะผู้ให้บริการ Strata Gateway ในหน้าการตั้งค่าเท่านั้น การรองรับการตั้งค่าผู้ให้บริการรายอื่นจะพร้อมใช้งานในเร็วๆ นี้ในช่วงเบต้า ในระหว่างนี้คุณสามารถตั้งค่าผู้ให้บริการผ่าน CLI หรือไฟล์คอนฟิกได้ เรามุ่งมั่นที่จะรักษาให้ Strata เปิดกว้างและไม่มีการผูกมัด",
  ...
  "settings.config.title": "เปิดไฟล์การตั้งค่า Strata ({{scope}})",
  "settings.config.placeholder":
    "ไฟล์การตั้งค่าจะถูกผสานตามลำดับ ไฟล์ที่ถูกทำเครื่องหมายว่าโหลดแล้วจะมีผลกับการตั้งค่าในปัจจุบัน",
  "settings.config.noWorkspace": "เปิดโฟลเดอร์พื้นที่ทำงานเพื่อแก้ไขไฟล์การตั้งค่า Strata ภายใน",
  "settings.config.openFailed": "ไม่สามารถเปิดไฟล์การตั้งค่า Strata ({{scope}}): {{message}}",
  "settings.config.source.xdg": "การตั้งค่า XDG ทั่วโลก",
  "settings.config.source.homeStrata": "การตั้งค่า .strata ของ Home",
  "settings.config.source.homeStratacode": "การตั้งค่า .stratacode ของ Home",
  "settings.config.source.homeOpencode": "การตั้งค่า .opencode ของ Home",
  "settings.config.source.envFile": "ไฟล์สภาพแวดล้อม STRATA_CONFIG",
  "settings.config.source.envDir": "STRATA_CONFIG_DIR",
  "settings.config.source.envContent": "การตั้งค่าสภาพแวดล้อมแบบอินไลน์",
  "settings.config.source.projectStrata": "การตั้งค่า .strata ของโปรเจกต์",
  "settings.config.source.projectRoot": "การตั้งค่ารูทของโปรเจกต์",
  "settings.config.source.projectStratacode": "การตั้งค่า .stratacode แบบเก่า",
  ...
  "session.cloud.import.placeholder": "ID เซสชัน, URL หรือคำสั่ง strata import",
  ...
  "deviceAuth.title": "เข้าสู่ระบบ Strata Code",
  ...
  "profile.action.login": "เข้าสู่ระบบด้วย Strata Code",
  ...
  "settings.aboutStrataCode.title": "เกี่ยวกับ Strata Code",

  "session.messages.empty": "เริ่มการสนทนาโดยพิมพ์ข้อความด้านล่าง",
  "session.messages.welcome": "Strata Code เป็นผู้ช่วยเขียนโค้ด AI ขอให้สร้างฟีเจอร์ แก้ไขบัก หรืออธิบายโค้ดเบสของคุณ",
  ...
  "settings.aboutStrataCode.status.connected": "เชื่อมต่อแล้ว",
  "settings.aboutStrataCode.status.connecting": "กำลังเชื่อมต่อ...",
  "settings.aboutStrataCode.status.disconnected": "ตัดการเชื่อมต่อ",
  "settings.aboutStrataCode.status.error": "ข้อผิดพลาด",
  "settings.aboutStrataCode.cliServer": "เซิร์ฟเวอร์ CLI",
  "settings.aboutStrataCode.status.label": "สถานะ:",
  "settings.aboutStrataCode.port.label": "พอร์ต:",
  "settings.aboutStrataCode.versionInfo": "ข้อมูลเวอร์ชัน",
  "settings.aboutStrataCode.version.label": "เวอร์ชัน:",
  "settings.aboutStrataCode.extensionName": "ส่วนขยาย Strata Code",
  "settings.aboutStrataCode.community": "ชุมชนและการสนับสนุน",
  "settings.aboutStrataCode.feedback.prefix": "หากคุณมีคำถามหรือข้อเสนอแนะ สามารถเปิด issue ได้ที่",
  "settings.aboutStrataCode.feedback.or": "หรือ",
  "settings.aboutStrataCode.support.prefix": "สำหรับคำถามเกี่ยวกับการเรียกเก็บเงินหรือบัญชี ติดต่อฝ่ายสนับสนุนลูกค้าที่",
  "settings.aboutStrataCode.resetSettings.title": "รีเซ็ตการตั้งค่า",
  ...
  "settings.aboutStrataCode.resetSettings.button": "รีเซ็ตการตั้งค่าทั้งหมด",
  "settings.aboutStrataCode.settingsTransfer.title": "ถ่ายโอนการตั้งค่า",
  "settings.aboutStrataCode.settingsTransfer.description":
    "ส่งออกหรือนำเข้าการตั้งค่าเพื่อถ่ายโอนระหว่างอินสแตนซ์ VS Code",
  "settings.aboutStrataCode.exportSettings": "ส่งออก",
  "settings.aboutStrataCode.importSettings": "นำเข้า",
  "settings.aboutStrataCode.importSettings.invalidJson": "ไฟล์ JSON ไม่ถูกต้อง กรุณาเลือกไฟล์การตั้งค่าที่ถูกต้อง",
  "settings.aboutStrataCode.importSettings.invalidConfig": "ไฟล์ไม่มีการตั้งค่า Strata ที่ถูกต้อง",
  "settings.aboutStrataCode.importSettings.tooLarge": "ไฟล์มีขนาดใหญ่เกินไป ไฟล์การตั้งค่าต้องมีขนาดไม่เกิน 1 MB",
  "settings.aboutStrataCode.importSettings.newerVersion":
    "ไฟล์นี้ถูกส่งออกจาก Strata เวอร์ชันใหม่กว่า การตั้งค่าบางรายการอาจถูกข้ามไป",
  "settings.aboutStrataCode.importSettings.success": "นำเข้าการตั้งค่าแล้ว ตรวจสอบการเปลี่ยนแปลงด้านบน จากนั้นคลิกบันทึก",
  ...
  "settings.aboutStrataCode.telemetry.openSettings": "เปิดการตั้งค่า Telemetry",
  ...
  "settings.language.description": 'เลือกภาษาสำหรับ UI ของ Strata Code "อัตโนมัติ" จะใช้ภาษาการแสดงผลของ VS Code',
  ...
  "settings.experimental.remote.description":
    "เปิดใช้งานการควบคุม Remote ของเซสชันผ่าน Strata Cloud ซึ่งจะส่งผลต่อ CLI บนเครื่องนี้ด้วย",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "โหลดคำแนะนำและทักษะจาก CLAUDE.md ในไดเรกทอรีการกำหนดค่า Claude Code ของคุณลงในเซสชัน เปิดใช้งานตัวเลือกนี้หากคุณต้องการให้ Strata ใช้คำแนะนำและทักษะจาก Claude Code ของคุณ จำเป็นต้องรีสตาร์ท",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "ไม่ได้กำหนดค่าเซิร์ฟเวอร์ MCP เพิ่มเซิร์ฟเวอร์ MCP ใน strata.jsonc หรือขอให้เอเจนต์เพิ่มให้คุณ",
  ...
  "settings.aboutStrataCode.legacyMigration.title": "การย้ายข้อมูลจากเวอร์ชันดั้งเดิม",
  "settings.aboutStrataCode.legacyMigration.description":
    "ย้ายการตั้งค่าจากการติดตั้ง Strata Code ก่อนหน้านี้ รวมถึงคีย์ API ของผู้ให้บริการและโมเดลเริ่มต้น",

  // Screen 1 — What's New
  "migration.whatsNew.title": "มีอะไรใหม่ใน Strata Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "แกนหลักขนาดเล็กและมีประสิทธิภาพเดียวกันในทุกผลิตภัณฑ์ Strata ประสบการณ์ที่คุ้นเคยไม่ว่าคุณจะเลือกทำงานอย่างไร",
