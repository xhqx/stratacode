...
import type { AssistantMessage, ToolPart } from "@stratacode/sdk/v2"
...
const shellPart: ToolPart = {
  ...
  state: {
    ...
    input: {
      ...
      command: `grep -n "migration\\|openMigration" packages/strata-vscode/webview-ui/src/types/messages.ts`,
    },
