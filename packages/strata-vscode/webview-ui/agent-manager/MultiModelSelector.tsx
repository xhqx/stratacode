...
import { STRATA_GATEWAY_ID, providerSortKey } from "../src/components/shared/model-selector-utils"
import {
...
export const MultiModelSelector: Component<{
  ...
  const visibleModels = createMemo(() => {
    const c = connected()
    return models().filter((m) => m.providerID === STRATA_GATEWAY_ID || c.includes(m.providerID))
  })
