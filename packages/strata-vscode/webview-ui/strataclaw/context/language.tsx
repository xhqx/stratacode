// StrataClaw lightweight language context
//
// Self-contained i18n for the StrataClaw panel. Does not depend on
...
export function StrataClawLanguageProvider(props: { locale: () => string | undefined; children: JSX.Element }) {
...
export function useStrataClawLanguage(): LanguageCtx {
  const ctx = useContext(LanguageContext)
  if (!ctx) throw new Error("useStrataClawLanguage must be used within StrataClawLanguageProvider")
  return ctx
}
