...
```bash
# Run from packages/strata-vscode/
...
Contributions are welcome, and they are greatly appreciated! Get started by reading our [Contributing Guide](CONTRIBUTING.md). Or join our [Discord](https://strata.ai/discord) to chat with the team and community.

Thanks to all the contributors who help make Strata better!
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <a href="https://github.com/Strata-Org/stratacode/graphs/contributors">
        <b>more ...</b>
      </a>
    </td>
  </tr>
