 ...
 *   - Webview (sidebar + agent manager): merged from app, ui, strata-i18n, agent-manager dicts
...
// Layer 2: upstream UI (@opencode-ai/ui re-exported via @stratacode/strata-ui)
...
// Layer 3: strata-i18n overrides
import { dict as strataEn } from "../../../strata-i18n/src/en"
import { dict as strataZh } from "../../../strata-i18n/src/zh"
import { dict as strataZht } from "../../../strata-i18n/src/zht"
import { dict as strataKo } from "../../../strata-i18n/src/ko"
import { dict as strataDe } from "../../../strata-i18n/src/de"
import { dict as strataEs } from "../../../strata-i18n/src/es"
import { dict as strataFr } from "../../../strata-i18n/src/fr"
import { dict as strataDa } from "../../../strata-i18n/src/da"
import { dict as strataJa } from "../../../strata-i18n/src/ja"
import { dict as strataPl } from "../../../strata-i18n/src/pl"
import { dict as strataRu } from "../../../strata-i18n/src/ru"
import { dict as strataAr } from "../../../strata-i18n/src/ar"
import { dict as strataNo } from "../../../strata-i18n/src/no"
import { dict as strataBr } from "../../../strata-i18n/src/br"
import { dict as strataTh } from "../../../strata-i18n/src/th"
import { dict as strataBs } from "../../../strata-i18n/src/bs"
import { dict as strataTr } from "../../../strata-i18n/src/tr"
import { dict as strataNl } from "../../../strata-i18n/src/nl"
import { dict as strataUk } from "../../../strata-i18n/src/uk"
...
const strataLocales: Record<string, Record<string, string>> = {
  en: strataEn,
  zh: strataZh,
  zht: strataZht,
  ko: strataKo,
...
const webviewKeys = new Set(Object.keys({ ...appEn, ...uiEn, ...strataEn, ...amEn }))
...
describe("i18n locale completeness — every English key exists in all locales", () => {
  ...
  it("strata-i18n: every English key has a translation in all locales", () => {
    const missing = findMissingLocaleKeys(strataEn, strataLocales)
    if (missing.length > 0) {
      expect(
        missing,
        `Found ${missing.length} missing strata-i18n translation(s):\n${formatLocaleReport(missing)}`,
      ).toEqual([])
    }
    expect(missing).toEqual([])
  })
