...
import { resolveContextDirectory, resolveWorkspaceDirectory } from "../../src/strata-provider-utils"
...
describe("resolveWorkspaceDirectory", () => {
  it("uses an explicit session worktree override", () => {
    const dir = resolveWorkspaceDirectory({
      ...
      sessionDirectories: new Map([["ses_worktree", "/repo/.strata/worktrees/feature"]]),
      workspaceDirectory: "/repo",
    })

    expect(dir).toBe("/repo/.strata/worktrees/feature")
  })
