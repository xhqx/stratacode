...
const STRATA_AUTO: ModelSelection = { providerID: "strata", modelID: "strata-auto/free" }

const providers: Record<string, Provider> = {
  strata: makeProvider("strata", ["strata-auto/free"]),
...
function env(): ResolveEnv {
  return {
    providers,
    connected: ["strata", "anthropic", "openai"],
