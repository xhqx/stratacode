...
const version = process.env.STRATA_VERSION ? process.env.STRATA_VERSION : packageJson.version
const prerelease = process.env.STRATA_PRE_RELEASE === "true"
...
const targets = [
  { target: "linux-x64", cliDir: "@stratacode/cli-linux-x64", binary: "strata" },
  { target: "linux-arm64", cliDir: "@stratacode/cli-linux-arm64", binary: "strata" },
  { target: "alpine-x64", cliDir: "@stratacode/cli-linux-x64-musl", binary: "strata" },
  { target: "alpine-arm64", cliDir: "@stratacode/cli-linux-arm64-musl", binary: "strata" },
  { target: "darwin-x64", cliDir: "@stratacode/cli-darwin-x64", binary: "strata" },
  { target: "darwin-arm64", cliDir: "@stratacode/cli-darwin-arm64", binary: "strata" },
  { target: "win32-x64", cliDir: "@stratacode/cli-windows-x64", binary: "strata.exe" },
  { target: "win32-arm64", cliDir: "@stratacode/cli-windows-arm64", binary: "strata.exe" },
]
...
for (const config of targets) {
  ...
  const vsixPath = join(outDir, `strata-vscode-${config.target}.vsix`)
