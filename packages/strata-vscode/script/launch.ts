#!/usr/bin/env bun
/**
 * Build the Strata VS Code extension and launch it in a development host.
 *
 * Usage:
...
const base = join(tmpdir(), `strata-vscode-dev-${hash}`)
...
async function launch() {
  ...
  if (mode === "dev") {
    ...
    args.push("--disable-extension=stratacode.strata-code")
  }
