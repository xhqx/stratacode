...
- Consider reusing strata-ui's `MessageNav` component
- Evaluate whether CLI session undo/redo/revert maps to Strata's checkpoint model or if extension needs its own git-based implementation
