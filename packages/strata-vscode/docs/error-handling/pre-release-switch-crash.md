...
**Priority:** P0
**Issue:** [#6083](https://github.com/Strata-Org/stratacode/issues/6083)
...
- Check if both versions attempt to spawn `strata serve` simultaneously causing port/race conflicts
