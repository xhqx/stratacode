...
- **Auto-discovery**: Consider adding a section showing auto-discovered rule sources (`.stratacode/rules/`, `AGENTS.md`) that the CLI loads regardless of explicit `config.instructions` entries
