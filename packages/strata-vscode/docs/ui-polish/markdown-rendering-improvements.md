...
**Priority:** P1
**Issue:** [#6088](https://github.com/Strata-Org/stratacode/issues/6088)

Headings h1-h6 render at the same visual size as body text. strata-ui CSS only resets margins, no distinct font sizes/weights.
