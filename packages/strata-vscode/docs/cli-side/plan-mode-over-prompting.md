...
**Priority:** P1
**Issue:** [#6143](https://github.com/Strata-Org/stratacode/issues/6143)

An experimental plan mode prompt exists (`Flag.STRATA_EXPERIMENTAL_PLAN_MODE`) that is verbose. Agent still tends to ask "Should I implement this?" repeatedly.
