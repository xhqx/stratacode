export const STRATA_PROVIDER_ID = "strata"
export const STRATA_AUTO = { providerID: STRATA_PROVIDER_ID, modelID: "strata-auto/free" } as const
...
export function createStrataFallbackProvider() {
  return {
    id: STRATA_PROVIDER_ID,
    name: "Strata Gateway",
