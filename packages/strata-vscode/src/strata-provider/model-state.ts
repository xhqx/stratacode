 ...
 *
 * Reads/writes ~/.local/state/strata/model.json (same file the CLI TUI uses)
...
async function resolve(client: StrataClient | null): Promise<string | undefined> {
...
async function read(client: StrataClient | null): Promise<Record<string, unknown>> {
...
function write(client: StrataClient | null, key: string, value: unknown): Promise<void> {
...
export async function reset(client: StrataClient | null, post: PostMessage): Promise<void> {
