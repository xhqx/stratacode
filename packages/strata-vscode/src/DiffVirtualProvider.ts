...
export class DiffVirtualProvider implements vscode.Disposable {
  ...
  constructor(private readonly extensionUri: vscode.Uri) {
    this.outputChannel = vscode.window.createOutputChannel("Strata Diff Virtual")
  }
  ...
  public open(diff: DiffVirtualFile): void {
    ...
    const panel = vscode.window.createWebviewPanel("strata-code.new.DiffVirtualPanel", title, vscode.ViewColumn.One, {
      enableScripts: true,
