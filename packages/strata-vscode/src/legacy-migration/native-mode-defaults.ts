/**
 * legacy-migration - Default values for native modes from the legacy Strata Code v5.x extension.
 *
...
/**
 * Built-in default values for each native mode slug from legacy Strata Code v5.x.
...
export const NATIVE_MODE_DEFAULTS: Record<string, NativeModeDefaults> = {
  ...
  code: {
    name: "Code",
    roleDefinition:
      "You are Strata Code, a highly skilled software engineer with extensive knowledge in many programming languages, frameworks, design patterns, and best practices.",
    whenToUse:
  ...
  ask: {
    name: "Ask",
    roleDefinition:
      "You are Strata Code, a knowledgeable technical assistant focused on answering questions and providing information about software development, technology, and related topics.",
    whenToUse:
  ...
  debug: {
    name: "Debug",
    roleDefinition:
      "You are Strata Code, an expert software debugger specializing in systematic problem diagnosis and resolution.",
    whenToUse:
  ...
  review: {
    name: "Review",
    roleDefinition:
      "You are Strata Code, an expert code reviewer with deep expertise in software engineering best practices, security vulnerabilities, performance optimization, and code quality. Your role is advisory - provide clear, actionable feedback on code quality and potential issues.",
    whenToUse:
