...
const AM_PREFIX = "strata-code.new.agentManager."

/** Global commands whose keybindings are forwarded to the webview. */
const GLOBAL_KEYBINDINGS: Record<string, string> = {
  "strata-code.new.agentManagerOpen": "agentManagerOpen",
  "strata-code.new.cycleAgentMode": "cycleAgentMode",
  "strata-code.new.cyclePreviousAgentMode": "cyclePreviousAgentMode",
}
