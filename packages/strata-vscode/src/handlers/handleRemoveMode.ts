...
export async function handleRemoveMode(provider: StrataProvider, name: string): Promise<void> {
...
try {
  ...
  const result = await provider.client.stratacode.removeAgent({ name, directory: dir })
