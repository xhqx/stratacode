...
export function handleOpenFile(provider: StrataProvider, filePath: string, line?: number, column?: number): void {
const uri = isAbsolutePath(filePath)
  ? vscode.Uri.file(filePath)
  : vscode.Uri.joinPath(vscode.Uri.file(provider.getWorkspaceDirectory(provider.currentSession?.id)), filePath)
