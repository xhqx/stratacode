...
export async function processExplanationBatches(provider: StrataProvider, client: any, targetDirectory: string, validDiffs: { file: string; patch: string }[], sessionContext?: string): Promise<void> {
const BATCH_SIZE = 5
let summary = ""
