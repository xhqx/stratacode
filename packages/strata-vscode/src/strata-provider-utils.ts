import type { Session, Agent, Event, ProviderListResponse } from "@stratacode/sdk/v2/client"
...
/**
 * Shared interface for the subset of StrataProvider state needed by session-refresh helpers.
 * Extracted here so the logic can be tested without importing StrataProvider (and vscode).
 */
...
export { mapSSEEventToWebviewMessage } from "./strata-provider/sse-mapper"
