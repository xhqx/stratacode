...
const STYLE_ID = "storybook-strata-theme"
...
export function applyStrataTheme(themeId: string, colorScheme: "light" | "dark") {
...
export function ThemeDecorator(props: ThemeDecoratorProps): JSX.Element {
  createEffect(() => {
    applyStrataTheme(props.theme, props.colorScheme)
  })
  return <props.Story />
}
