...
const mainNavItems: NavItem[] = [
  ...
  { label: "Strata Gateway", href: "/gateway" },
  { label: "StrataClaw", href: "/strataclaw" },
  { label: "Contributing", href: "/contributing" },
]

const contributingItems: DropdownItem[] = [
  { label: "Contributing Guide", href: "/contributing", description: "How to contribute to Strata Code" },
  {
    label: "Code of Conduct",
    href: "https://github.com/Strata-Org/stratacode?tab=coc-ov-file",
    description: "Our community guidelines",
  },
  { label: "GitHub Repository", href: "https://github.com/Strata-Org/", description: "View source and issues" },
  { label: "Discord Community", href: "https://strata.ai/discord", description: "Join our community" },
]
...
const helpItems: DropdownItem[] = [
  ...
  { label: "Support", href: "https://strata.ai/support", description: "Get help from the team" },
  {
    label: "Changelog",
    href: "https://github.com/Strata-Org/stratacode/releases",
...
function preview(url: string) {
  ...
  if (value.hostname !== "strata.ai" || !value.pathname.startsWith("/docs")) return url
    ...
    <header className="top-header">
      ...
      <div className="top-bar">
        ...
        <Link href="/" className="logo-link flex gap-2 items-center">
          ...
          <div>
            <span className="logo-text font-brand">Strata Code</span>
        ...
        <div className="right-actions">
          ...
          <ThemeToggle />
          <Link href="https://strata.ai/github" className="github-link desktop-nav">
            GitHub
          </Link>
          <Link href="https://app.strata.ai" className="signin-btn desktop-nav">
            Sign in
          </Link>
        </div>
      </div>
      ...
      <div className="announcement-banner">
        <p>
          The all-new Strata Code extension is here, rebuilt on the{" "}
          <Link href="/code-with-ai/platforms/vscode/whats-new">Strata CLI</Link> for speed, flexibility, and continued
          access to 500+ models via the Strata Gateway →
        </p>
      </div>
