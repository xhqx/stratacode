module.exports = [
  {
    source: "/docs/contributing/cline-to-strata-migration",
  ...
  {
    source: "/docs/features/mcp/using-mcp-in-strata-code",
    destination: "/docs/automate/mcp/using-in-strata-code",
    basePath: false,
    permanent: true,
  },
  {
  ...
  },
  {
    ...
    destination: "/docs/getting-started/using-strata-for-free",
    basePath: false,
    permanent: true,
  },
  {
  ...
  {
    source: "/docs/automate/strataclaw/:path*",
    destination: "/docs/strataclaw/:path*",
    basePath: false,
    permanent: true,
  },
  {
  ...
  // ============================================
  {
    source: "/docs/strataclaw/suggested-configuration",
    destination: "/docs/strataclaw/end-to-end",
    basePath: false,
    permanent: true,
  },
]
