---
title: "Deploy & Secure"
description: "Deploy applications and manage security with Strata Code"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Deploy your applications directly from Strata Code and manage security with AI-powered reviews and scans.
{% /callout %}
