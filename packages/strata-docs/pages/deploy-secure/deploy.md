---
title: "Deploy"
description: "Deploy your applications with Strata Code"
---

# Deploy

Strata Deploy lets you ship **Next.js** and **static sites** directly from Strata Code, with:

- **One-click deployment** from the Strata Code dashboard
...
2. Click **Configure** and follow the prompts to connect GitHub to Strata Code
...
- Navigate to your [Organization dashboard](https://app.strata.ai/organizations) or [Profile](https://app.strata.ai/profile)
...
Strata Deploy does **not** include built-in database hosting, but you can connect to any external database service.

---

## Environment Variables

Strata Deploy supports Environment Variables and Secrets. Add the variable **key** and **value** during the **Create New Deployment** step, and toggle to mark as secrets.
