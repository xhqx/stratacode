...
const terminalContent = {
  installation: (
    <>
      <span className="terminal-comment"># Install Strata Code VS Code Extension</span>
      {"\n"}
      <span className="terminal-prompt">$</span> code --install-extension stratacode.strata-code
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># Or install via CLI</span>
      {"\n"}
      <span className="terminal-prompt">$</span> npm install -g @stratacode/cli
    </>
  ),
  gateway: (
    <>
      <span className="terminal-comment"># Call Strata Gateway with a quick curl script</span>
      {"\n"}
      <span className="terminal-prompt">$</span> export STRATA_API_KEY="YOUR_API_KEY"
      {"\n"}
      <span className="terminal-prompt">$</span> curl https://api.strata.ai/api/gateway/chat/completions \{"\n"}
      -H "Authorization: Bearer $STRATA_API_KEY" \{"\n"}
      -H "Content-Type: application/json" \{"\n"}
      {`  -d '{"model":"anthropic/claude-sonnet-4.5","messages":[{"role":"user","content":"Say hi from Strata Gateway"}]}'`}
    </>
  ),
  firstTask: (
    <>
      <span className="terminal-comment"># Start a new task with Strata Code</span>
      {"\n"}
      <span className="terminal-prompt">$</span> strata "Create a React component for a user profile"
      {"\n"}
      {"\n"}
      <span className="terminal-comment">
        # Or for interactive sessions, just run the Strata CLI in your project folder
      </span>
      {"\n"}
      <span className="terminal-prompt">$</span> strata
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># Run in architect mode for planning</span>
      {"\n"}
      <span className="terminal-prompt">$</span> strata --mode architect "Design a REST API"
    </>
  ),
  customRules: (
    <>
      ...
      {"\n"}
      <span className="terminal-prompt">$</span> touch .stratacode/rules.md
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># Or use the CLI to add rules</span>
      {"\n"}
      <span className="terminal-prompt">$</span> strata rules add "Always use TypeScript"
      {"\n"}
      <span className="terminal-prompt">$</span> strata rules add "Follow React best practices"
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># List all active rules</span>
      {"\n"}
      <span className="terminal-prompt">$</span> strata rules list
    </>
  ),
}
...
const categories = [
  {
    title: "Get Started",
    description: "Install Strata Code and get up and running in minutes",
  ...
  {
    title: "Code with AI",
    description: "Learn how to use Strata Code to write, edit, and understand code",
    href: "/code-with-ai",
    icon: (
      <svg className="category-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  },
  {
    ...
    links: [
      ...
      { title: "Strata for Teams", href: "/collaborate" },
  ...
  {
    title: "Contributing",
    description: "Help improve Strata Code and learn about its architecture",
    href: "/contributing",
    icon: (
      <svg className="category-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        <path
    ...
    <div className="homepage">
      ...
      <section className="hero">
        <div className="hero-content">
          <h1 className="hero-title">Strata Code Documentation</h1>
          <p className="hero-subtitle">
            Explore our guides and examples to build with Strata Code, the most popular open source coding agent.
          </p>
          <div className="hero-buttons">
            <Link href="/getting-started" className="btn btn-primary">
              Get started with Strata Code →
            </Link>
      ...
      <section className="terminal-section">
        <div className="terminal-intro">
          ...
          <p className="terminal-description">Get started quickly with common Strata Code commands</p>
        </div>
        ...
        <div className="footer-grid">
          <div className="footer-item">
            ...
            <div>
              ...
              <Link href="https://strata.ai/discord" className="footer-link">
                Join our Discord
              </Link>
            </div>
          </div>
          <div className="footer-item">
            ...
            <div>
              ...
              <Link href="https://github.com/Strata-Org/stratacode/releases" className="footer-link">
                Changelog
              </Link>
            </div>
          </div>
          <div className="footer-item">
            ...
            <div>
              ...
              <Link href="https://github.com/Strata-Org/stratacode/issues" className="footer-link">
                Report an issue
              </Link>
            </div>
          </div>
