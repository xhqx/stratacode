---
title: "Code Actions"
description: "Quick code actions and refactoring with Strata Code"
---

# Code Actions

Code Actions are a powerful feature of VS Code that provide quick fixes, refactorings, and other code-related suggestions directly within the editor. Strata Code integrates with this system to offer AI-powered assistance for common coding tasks.
...
- **Explain Code:** Asks Strata to explain the selected code.
- **Fix Code:** Asks Strata to fix problems in the selected code.
- **Improve Code:** Asks Strata to suggest improvements to the selected code.
...
- **Fix Command:** Asks Strata to fix a failed terminal command.
- **Explain Command:** Asks Strata to explain a terminal command or its output.
...
Clicking the lightbulb, right-clicking and selecting "Strata Code", or using the keyboard shortcut (`Ctrl+.` or `Cmd+.` on macOS, by default), displays a menu of available actions.

{% image src="/docs/img/code-actions/code-actions-1.png" alt="VS Code code actions in line with code" width="500" /%}

## Strata Code's Code Actions

Strata Code provides the following Code Actions:

- **Add to Context:** Quickly adds the selected code to your chat with Strata, including line numbers so Strata knows exactly where the code is from. It's listed first in the menu for easy access. (More details below).
- **Explain Code:** Asks Strata Code to explain the selected code.
- **Fix Code:** Asks Strata Code to fix problems in the selected code (available when diagnostics are present).
- **Improve Code:** Asks Strata Code to suggest improvements to the selected code.

### Add to Context Deep Dive

The **Add to Context** action is listed first in the Code Actions menu so you can quickly add code snippets to your conversation. When you use it, Strata Code includes the filename and line numbers along with the code.

This helps Strata understand the exact context of your code within the project, allowing it to provide more relevant and accurate assistance.
...
There are three main ways to use Strata Code's Code Actions:
...
4.  **Choose an Action:** Select the desired Strata Code action from the menu.
5.  **Review and Approve:** Strata Code will propose a solution in the chat panel. Review the proposed changes and approve or reject them.
...
3.  **Choose "Strata Code":** Select the "Strata Code" option from the context menu. A submenu will appear with the available Strata Code actions.
...
3.  **Type a Command:** Type "Strata Code" to filter the commands, then choose the relevant code action (e.g., "Strata Code: Explain Code"). You can also type the start of the command, like "Strata Code: Explain", and select from the filtered list.
4.  **Review and Approve:** Strata Code will propose a solution in the chat panel. Review the proposed changes and approve or reject them.

## Code Actions and Current Task

Each code action gives you two options:

- **in New Task:** Select this to begin a conversation with Strata centered around this code action.
...
1.  **Open the Prompts Tab:** Click the {% codicon name="notebook" /%} icon in the Strata Code top menu bar.
...
By using Strata Code's Code Actions, you can quickly get AI-powered assistance directly within your coding workflow. This can save you time and help you write better code.
