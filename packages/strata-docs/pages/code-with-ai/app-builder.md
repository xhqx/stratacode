---
title: "App Builder"
description: "Build complete applications with Strata Code"
---

# App Builder

Strata's **App Builder** lets you create end-to-end applications through natural language conversation. Describe what you want to build, watch it come to life in a real-time preview, and deploy directly from your Strata dashboard. No local environment setup required.
...
- **Active Strata Code account**  
  Sign up or log in at [app.strata.ai](https://app.strata.ai)

---

## Cost

- You pay only for the AI model usage via Strata Code credits
...
1. Navigate to **[App Builder](https://app.strata.ai/app-builder)** from your Strata dashboard.
