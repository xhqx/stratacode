...
description: "Questions about accounts and integrations in Strata Code"
tocDepth: 2
---

# Account and Integration

This section contains questions about accounts and integrations in Strata Code.
...
This process involves removing the **Strata Connect** application from your GitHub account settings.
...
2. Find **Strata Connect** in the list of installed applications
3. Click **Configure** next to Strata Connect
4. From the configuration page, you can either:
   - **Uninstall** the integration completely, or
   - **Edit** which repositories are connected

{% callout type="tip" %}
If you'd like to reconnect GitHub later, simply open your Strata Code profile, go to **Integrations**, and connect GitHub again.
{% /callout %}
