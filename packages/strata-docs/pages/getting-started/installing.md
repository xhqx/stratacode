---
title: "Installation"
description: "How to install Strata Code on your system"
---

# Installation

Get started with Strata Code by installing it on your preferred platform. Choose your development environment below:
...
The current Strata Code extension is built on the [Strata CLI](https://github.com/Strata-Org/stratacode) and is distributed as the **pre-release version** on the VS Code Marketplace.

1. Open VS Code
2. Go to Extensions (`Ctrl+Shift+X` / `Cmd+Shift+X`)
3. Search for "Strata Code"
...
The legacy extension is the previous version of Strata Code for VS Code. It is still available but is no longer actively developed. We recommend installing the current extension (see the **VS Code** tab).
...
For VS Code-compatible editors like VSCodium, Gitpod, Eclipse Theia, and Windsurf, you can browse and install directly from the [Strata Code page on Open VSX Registry](https://open-vsx.org/extension/stratacode/Strata-Code).
...
4. Search for "Strata Code"
5. Select "Strata Code" and click **Install**
...
1. **Download the VSIX file:**
   - Find official releases on the [Strata Code GitHub Releases page](https://github.com/Strata-Org/stratacode/releases)
   - Download the `.vsix` file from the [latest release](https://github.com/Strata-Org/stratacode/releases/latest)
...
1. Open the [Strata Code GitHub Releases page](https://github.com/Strata-Org/stratacode/releases)
...
{% image src="/docs/img/installing-vsix.png" alt="Installing Strata Code using VS Code's Install from VSIX dialog" width="600px" caption="Installing Strata Code using VS Code's \"Install from VSIX\" dialog" /%}
...
- Restart VS Code
- Verify Strata Code is listed and enabled in Extensions
- Try disabling and re-enabling the extension in Extensions
- Check Output panel for errors (View → Output, select "Strata Code")
...
- [Your First Task](/docs/code-with-ai/agents/chat-interface) - Learn the basics of working with Strata Code
...
- Submit issues on [GitHub](https://github.com/Strata-Org/stratacode/issues)
