...
description: "Configure Strata Code and connect to your AI providers"
---

# Setup & Authentication

When you install Strata Code, you'll be prompted to sign in or create a free account. This automatically configures everything you need to get started.

## Quick Start with Strata Account
...
1. Click **"Try Strata Code for Free"** in the extension
2. Sign in with your Google account
3. Allow VS Code to open the authorization URL

{% image src="/docs/img/signupflow.gif" alt="Sign up and registration flow with Strata Code" /%}
...
[Add credits to your account](https://app.strata.ai/profile), or sign up for [Strata Pass](https://strata.ai/features/strata-pass).
{% /callout %}

## Strata Gateway API Key

If you're using the [Strata AI Gateway](/docs/gateway/) outside of the Strata Code extension (for example, with the Vercel AI SDK or OpenAI SDK), you'll need an API key:

1. Go to [app.strata.ai](https://app.strata.ai)
...
If you prefer to use your own API key or existing subscription, Strata Code supports **over 30 providers**. Here are some popular options to get started:
...
These are just a few examples! Strata Code supports many more providers including Google Gemini, DeepSeek, Mistral, Ollama (for local models), AWS Bedrock, Google Vertex, and more. See the complete list at [AI Providers](/docs/ai-providers/).
{% /callout %}

### ChatGPT Plus/Pro Subscription

Already have a ChatGPT subscription? You can use it with Strata Code through the [OpenAI ChatGPT provider](/docs/ai-providers/openai-chatgpt-plus-pro)—no API key needed.
...
1. Open the Strata Code sidebar in VS Code
...
You can also use `strata auth login` for providers that support OAuth (like GitHub Copilot). The extension reads from the same underlying config files as the CLI, so provider settings are shared.
...
Or use `strata auth login` for providers that support OAuth (like GitHub Copilot).
...
1. Click the {% strata-code-icon /%} icon in the VS Code sidebar
...
Reach out to our [support team](mailto:hi@strata.ai) or join our [Discord community](https://strata.ai/discord).
{% /callout %}
