...
description: "How to capture console logs and report issues with Strata Code"
---
...
1. Make sure the **Strata Code panel is open** in your IDE (the debug target won't appear unless the webview is active)
...
4. Find the entry with `"title": "Strata Code"` and open the `devtoolsFrontendUrl` link
5. Chrome DevTools will open connected to the Strata webview—click the **Console** tab
...
If you're unable to resolve the issue, please inspect the console logs, remove any secrets, and send the logs to **[hi@stratacode.ai](mailto:hi@stratacode.ai)** along with the following:

- The error messages from the console
- Steps to reproduce the issue
- Screenshots or screen recordings of the issue
- Your IDE and Strata Code version
