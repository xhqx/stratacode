...
## Why Strata Code Uses MCP

Strata Code leverages MCP to provide:
...
MCP creates a universal connector between Strata Code and external services, with REST APIs often powering those services behind the scenes.
