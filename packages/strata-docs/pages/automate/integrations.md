---
title: "Integrations"
description: "Overview of Strata Code integrations"
---

# Strata Code Integrations

Strata Integrations lets you connect your GitHub or GitLab account (soon Bitbucket) to enable advanced features inside Strata Code. Once connected, Strata can access your repositories securely, enabling features like **Code Reviews**, **Cloud Agents**, and **Strata Deploy**.
...
- **Connect GitHub or GitLab to Strata Code** in a few clicks
- **Enable advanced features** like Cloud Agents, Code Reviews, and Strata Deploy
- **Authorize repository access** so Strata can analyze and work with your code
...
- For GitHub: You need permission to install GitHub Apps for the repositories you want Strata to access.
...
Go to your **Personal** or **Organization Dashboard**, and navigate to the [Integrations](https://app.strata.ai/integrations) tab.

### 2. Start the Connection Flow

1. Click **Configure** on the GitHub panel.
2. You'll be redirected to GitHub to authorize the **StrataConnect** App.
3. Select the GitHub account or organization you want to connect.

### 3. Choose Repository Access

GitHub will ask which repositories you want Strata to access:
...
- You'll return to the Strata Integrations page.
- GitHub will show a **Connected** status.
- Your Strata workspace can now access GitHub repositories securely.
...
1. Go to the **Integrations** page:
   - **Personal**: [app.strata.ai/integrations/gitlab](https://app.strata.ai/integrations/gitlab)
   - **Organization**: Your organization → Integrations → GitLab
2. Click **Connect GitLab**
3. Authorize the application on GitLab
4. You'll be redirected back to Strata with the connection active
...
2. Create a new application:
   - **Name**: `Strata Code`
   - **Redirect URI**: `https://app.strata.ai/api/integrations/gitlab/callback`
   - **Scopes**: `api`, `read_user`, `read_repository`, `write_repository`
   - **Confidential**: Yes
3. Copy the **Application ID** and **Secret**
4. In Strata, go to the GitLab integration page
...
> PAT tokens cannot be refreshed automatically. When your token expires, create a new one in GitLab and reconnect in Strata.
...
Once your Git provider is connected, the following features are enabled in Strata:

### Cloud Agents

- Run Strata Code in the cloud from any device
...
- Deploy Next.js 14 & 15 apps directly from Strata
...
- Update which repositories Strata has access to
...
> Disconnecting from Strata does not revoke OAuth tokens on GitLab's side. You can manually revoke them from **GitLab → User Settings → Applications → Authorized Applications**.
...
Ensure the StrataConnect App is installed for the correct GitHub org and that repo access includes the repositories you need.
...
- **PAT**: Create a new token in GitLab and reconnect in Strata.
...
- Verify the redirect URI matches: `https://app.strata.ai/api/integrations/gitlab/callback`
