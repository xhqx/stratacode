---
title: "Automate"
description: "Automate your development workflows with Strata Code"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Automate repetitive tasks, set up AI-powered code reviews, and extend Strata Code's capabilities with integrations and MCP servers.
{% /callout %}
...
Connect Strata Code to external tools and services:
...
- [**Using MCP in Strata Code**](/docs/automate/mcp/using-in-strata-code) — Configuration guide
...
Connect Strata Code with your development tools:
...
Customize and extend Strata Code's capabilities:
...
2. Configure [MCP servers](/docs/automate/mcp/using-in-strata-code) for external integrations
