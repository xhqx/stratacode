...
description: "Connect your StrataClaw agent to 1Password to securely manage credentials"
---

# 1Password Integration Guide

Connect your StrataClaw agent to 1Password to securely manage credentials. This allows your agent to fetch API keys or passwords without ever seeing them in plain text.
...
2. Create a **New Vault** (e.g., name it `Strata-Agent-Vault`).
...
## Step 3: Configure StrataClaw

1. Navigate to your StrataClaw dashboard: [app.strata.ai/claw](https://app.strata.ai/claw).
