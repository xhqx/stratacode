...
description: "How StrataClaw instances are structured"
---

# Architecture Notes

For advanced users — how StrataClaw instances are structured:
...
- **Network isolation** — OpenClaw binds to loopback only; external traffic is proxied through a Strata controller.
