...
description: "Connect a GitHub account to your StrataClaw agent for repository access"
---

# GitHub Integration

Connect a GitHub account to your StrataClaw agent so it can clone repositories, push commits, open pull requests, and leave code reviews — all autonomously.
...
### Step 3: Enter credentials in StrataClaw
...
StrataClaw accepts both GitHub token formats:
...
When your instance starts, StrataClaw automatically:
...
- Tokens are encrypted at rest using StrataClaw's secret management system
