...
**Action:** Install the Strata CLI to enable AI-assisted terminal workflows:
...
**Action:** Use [Strata Deploy](/docs/deploy-secure/deploy) to spin up live URLs for branches, allowing your team to verify changes before merging.
...
Most teams start with Code mode and stop there. But Strata's other modes unlock additional value.
...
4. Consider Strata Deploy to validate AI output
