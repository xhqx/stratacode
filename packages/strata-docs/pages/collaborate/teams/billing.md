...
Strata seats uses a transparent, two-part billing system: a monthly subscription per seat, plus pay-as-you-go Strata credits with zero markup.

{% callout type="note" %}

Strata Code seats purchases of Teams or Enterprise are separate from Strata credits.

No Strata credits are included with a Teams or Enterprise purchase.

{% /callout %}

## Organization Credits

Organization Owners can purchase Strata credits on the [Organization dashboard](https://app.strata.ai).

Organization credits are purchased on behalf of all users in the organization. Every member of the organization can use the credits in the organization's balance with the Strata Code model provider.
...
Organization members can use organization credits by choosing the correct organization profile in the dropdown in the Profiles tab of the Strata Code extension.
...
In order to add Members to your Strata Code Organization, you must have seat(s) available for them.
...
Ensure your team has uninterrupted access to Strata Code by enabling Automatic Top-Up. This feature keeps your organization's balance funded so you never have to worry about manual recharges.
...
- **Automatic Thresholds** — Once enabled, Strata Code will automatically recharge your balance whenever it falls below $50.00.
...
Invoices for any payment on the Strata Code platform, for seats or credits, will be available in the Invoices tab.
