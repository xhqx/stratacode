---
title: "About Plans"
description: "Overview of Strata Code plans and pricing"
---

# About Plans

Strata Code accelerates development with AI-driven code generation and task automation. You can use Strata Code as an open source extension in VS Code or JetBrains IDEs.
...
Strata Code's paid plans, Teams and Enterprise, are the solution for these organizations.

{% callout type="note" %}

Purchases of Strata Code's paid plans are separate from model provider credits.

No credits are included with a Teams or Enterprise plan purchase.

{% /callout %}

## What You Get from Strata Teams
...
## What You Get from Strata Enterprise
...
**Cost:** [Contact Sales](https://strata.ai/contact-sales)
