---
title: "Migration"
description: "Migrate your team to Strata Code Enterprise"
---

# Migration

Switch to **Strata Teams** or **Strata Enterprise** from other AI coding tools and experience transparent pricing, no vendor lock-in, and superior team management capabilities.

## Why Teams Switch to Strata
...
**Strata Teams** and **Strata Enterprise** show you exactly what each AI request costs - no markup, no hidden fees, complete transparency.

### No Rate Limiting

**Other tools** slow you down with rate limits and model switching when you need AI most.

**Strata Teams** and **Strata Enterprise** never limit your usage - pay for what you use, use what you need.

### True Team Management

**Other solutions** offer basic user management with limited visibility.

**Strata Teams** provides comprehensive team analytics, role-based permissions, and detailed usage insights, while **Strata Enterprise** adds advanced governance, audit logging, and enterprise-level security controls.
...
### What You Gain with Strata Teams or Strata Enterprise
...
3. **Calculate current costs** (if visible) vs. Strata pricing
4. **Plan migration timeline** to minimize disruption

**Step 2: Strata Setup**

1. **Create organization** at [app.strata.ai](https://app.strata.ai)
2. **Subscribe to Teams ($15/user/month)** or **Enterprise ([Contact Sales](https://strata.ai/contact-sales))**
3. **Configure team settings** and usage policies
4. **Purchase initial AI credits** based on usage estimates

**Step 3: Team Migration**

1. **Invite team members** to Strata
2. **Install Strata Code extension** alongside Cursor initially
3. **Migrate projects gradually** starting with non-critical work
4. **Train team** on Strata Code features and workflows

**Step 4: Full Transition**

1. **Monitor usage patterns** in Strata dashboard
...
2. **Install Strata Code** extension for team members
3. **Start with simple tasks** in Strata Code
4. **Compare results** and team satisfaction

**Phase 2: Gradual Transition (Week 3-4)**

1. **Use Strata Code** for new projects
...
3. **Optimize Strata Plan** settings
...
Strata Code uses a compatible rules system that supports Cursor and Windsurf patterns. Migrating your custom rules and configurations is straightforward and typically takes 5-10 minutes per project.

**Quick Overview:**

- **Project rules**: `.cursor/rules/*.mdc` → `.stratacode/rules/*.md` (remove YAML frontmatter, keep Markdown content)
- **Legacy rules**: `.cursorrules` → `.stratacode/rules/legacy-rules.md`
- **AGENTS.md**: Works identically in Strata Code (no conversion needed)
- **Global rules**: Recreate in `~/.stratacode/rules/*.md` directory

Strata Code also supports mode-specific rules (`.stratacode/rules-{mode}/`), which Cursor and Windsurf don't have. This allows different rules for different workflows (e.g., Code mode vs Debug mode).
...
- Strata Code extension installation and setup
...
Ready to make the switch? Contact our migration team at migrations@strata.ai to plan your transition to transparent AI coding.
