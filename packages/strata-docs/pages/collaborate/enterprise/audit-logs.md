...
Audit Logs record key actions that occur in the management of your Strata seats, including user logins, adding or removing models, providers, and modes, and role changes.
...
Here is the list of all events included in the Strata Code audit logs:
