...
Paging should **only occur on Recommended Models when using the Strata Gateway**. All other alerts should be tickets, and some may be configured to be ignored.
