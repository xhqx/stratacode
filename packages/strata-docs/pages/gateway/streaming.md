---
title: "Streaming"
description: "Learn how to implement real-time streaming responses with the Strata AI Gateway using Server-Sent Events (SSE)."
---

# Streaming

The Strata AI Gateway supports streaming responses from all models using Server-Sent Events (SSE). Streaming allows your application to display tokens as they're generated, providing a more responsive user experience.
...
const response = await fetch("https://api.strata.ai/api/gateway/chat/completions", {
  method: "POST",
  headers: {
