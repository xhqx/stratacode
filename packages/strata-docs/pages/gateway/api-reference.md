---
title: "API Reference"
description: "Complete API reference for the Strata AI Gateway, including chat completions, FIM completions, and model listing endpoints."
---

# API Reference

The Strata AI Gateway provides an OpenAI-compatible API. All endpoints use the base URL:
...
```bash
curl -X POST "https://api.strata.ai/api/fim/completions" \
  -H "Authorization: Bearer $STRATA_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
