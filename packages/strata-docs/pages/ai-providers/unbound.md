...
# Using Unbound With Strata Code
...
2.  **Create an Application:** Go to the [Connect](https://gateway.getunbound.ai/connect) page and select "Strata Code".
3.  **Copy the API Key:** Copy the API key to your clipboard.

## Supported Models

Unbound allows you configure a list of supported models in your application, and Strata Code will automatically fetch the list of available models from the Unbound API.
...
Unbound is not yet available as a CLI provider. Check the [Strata Code releases](https://github.com/Strata-Org/stratacode/releases) for updates on provider support.
{% /callout %}
