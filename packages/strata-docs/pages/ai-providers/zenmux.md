...
3. **Configure in Strata Code:** Add your API key to Strata Code settings.
...
- Check the [Strata Code GitHub repository](https://github.com/Strata-Org/stratacode) for integration-specific issues
