---
title: Fireworks AI with Strata Code
---

# Using Fireworks AI With Strata Code
...
3. **Create a Key:** Click "Create API key" and give your key a descriptive name (e.g., "Strata Code").
