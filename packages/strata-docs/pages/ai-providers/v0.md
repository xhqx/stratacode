...
# Using v0 With Strata Code

Strata Code supports v0, Vercel's AI model provider that offers an OpenAI-compatible API. This allows you to use v0's models with Strata Code through the familiar OpenAI API interface.

## Prerequisites

To use v0 with Strata Code, you'll need:
...
Setting up v0 in Strata Code is straightforward:

1. In Strata Code settings (click the {% codicon name="gear" /%} icon):
...
<!-- <img src="/docs/img/providers/v0-setup.png" alt="v0 configuration in Strata Code settings" width="600" /> -->
