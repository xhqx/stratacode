...
# Using SAP AI Core With Strata Code

Strata Code supports accessing models through SAP AI Core, a service in the SAP Business Technology Platform that lets you efficiently run AI scenarios in a standardized, scalable, and hyperscaler-agnostic manner.
...
To use SAP AI Core with Strata Code, you'll need to create a service key for your SAP AI Core service instance:
...
Strata Code applies the following filters when fetching models:
...
3. Configure Strata Code with your credentials
