...
# Using ChatGPT Subscriptions With Strata Code
...
5. Back in Strata Code settings, pick a model from the dropdown.
6. Save.
...
- **You can't use arbitrary OpenAI API models.** This provider only exposes the models listed in Strata Code's Codex model catalog.
- **You can't export/migrate your sign-in state with settings export.** OAuth tokens are stored in VS Code SecretStorage, which isn't included in Strata Code's settings export.
