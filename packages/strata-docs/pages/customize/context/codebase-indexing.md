...
Codebase Indexing enables semantic code search across your entire project using AI embeddings. Instead of searching for exact text matches, it understands the _meaning_ of your queries, helping Strata Code find relevant code even when you don't know specific function names or file locations.
...
4. **Provides the [`semantic_search`](/docs/automate/tools/semantic-search) tool** to Strata Code for intelligent code discovery
...
- **Enhanced AI Understanding**: Strata Code can better comprehend and work with your codebase
...
3. If you don't see the icon, open Strata Code settings (<Codicon name="gear" />) and search for **Codebase Indexing**
...
- Files matching `.gitignore` and [`.stratacodeignore`](/docs/customize/context/stratacodeignore) patterns
...
Once indexed, Strata Code can use the [`semantic_search`](/docs/automate/tools/semantic-search) tool to find relevant code:
...
The tool provides Strata Code with:
