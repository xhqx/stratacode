export const dict = {
  ...
  "provider.connect.strataGateway.line1":
    "Strata Gateway zapewnia dostęp do wyselekcjonowanego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodowania.",
  ...
  "provider.connect.strataGateway.visit.prefix": "Odwiedź ",
  "provider.connect.strataGateway.visit.link": "strata.ai",
  "provider.connect.strataGateway.visit.suffix": ", aby otrzymać swój klucz API.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Polecane",
  "dialog.provider.strata.note": "Dostęp do ponad 500 modeli AI",
