export const dict = {
  ...
  "provider.connect.strataGateway.line1":
    "Strata Gateway gir deg tilgang til et utvalgt sett med pålitelige, optimaliserte modeller for kodingsagenter.",
  ...
  "provider.connect.strataGateway.visit.prefix": "Besøk ",
  "provider.connect.strataGateway.visit.link": "strata.ai",
  "provider.connect.strataGateway.visit.suffix": " for å hente API-nøkkelen din.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Anbefalt",
  "dialog.provider.strata.note": "Tilgang til 500+ AI-modeller",
