...
export const dict = {
  ...
  "provider.connect.strataGateway.line1":
    "Strata Gateway geeft je toegang tot een gecureerde set van betrouwbare, geoptimaliseerde modellen voor coding agents.",
  ...
  "provider.connect.strataGateway.visit.prefix": "Bezoek ",
  "provider.connect.strataGateway.visit.link": "strata.ai",
  "provider.connect.strataGateway.visit.suffix": " om je API key op te halen.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Aanbevolen",
  "dialog.provider.strata.note": "Toegang tot 500+ AI modellen",
