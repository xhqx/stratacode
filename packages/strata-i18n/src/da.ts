export const dict = {
  ...
  "provider.connect.strataGateway.line1":
    "Strata Gateway giver dig adgang til et udvalgt sæt pålidelige, optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.strataGateway.visit.prefix": "Besøg ",
  "provider.connect.strataGateway.visit.link": "strata.ai",
  "provider.connect.strataGateway.visit.suffix": " for at hente din API-nøgle.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Anbefalede",
  "dialog.provider.strata.note": "Adgang til 500+ AI-modeller",
