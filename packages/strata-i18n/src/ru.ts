export const dict = {
  ...
  "provider.connect.strataGateway.line1":
    "Strata Gateway предоставляет доступ к подборке надёжных оптимизированных моделей для агентов кодирования.",
  "provider.connect.strataGateway.line2":
    "С одним API-ключом вы получите доступ к моделям Claude, GPT, Gemini, GLM и другим.",
  "provider.connect.strataGateway.visit.prefix": "Посетите ",
  "provider.connect.strataGateway.visit.link": "strata.ai",
  "provider.connect.strataGateway.visit.suffix": ", чтобы получить ваш API-ключ.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Рекомендуемые",
  "dialog.provider.strata.note": "Доступ к 500+ моделям ИИ",
