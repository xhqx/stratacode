export const dict = {
  ...
  "provider.connect.strataGateway.line1":
    "Strata Gateway, kodlama ajanları için optimize edilmiş güvenilir modellere erişim sağlar.",
  ...
  "provider.connect.strataGateway.visit.prefix": "API anahtarınızı almak için ",
  "provider.connect.strataGateway.visit.link": "strata.ai",
  "provider.connect.strataGateway.visit.suffix": " adresini ziyaret edin.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Önerilen",
  "dialog.provider.strata.note": "500+ AI modeline erişim",
