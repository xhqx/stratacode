export const dict = {
  ...
  "provider.connect.strataGateway.line1":
    "Strata Gatewayは、コーディングエージェント向けに厳選された信頼性の高い最適化モデルへのアクセスを提供します。",
  "provider.connect.strataGateway.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.strataGateway.visit.prefix": "",
  "provider.connect.strataGateway.visit.link": "strata.ai",
  "provider.connect.strataGateway.visit.suffix": " にアクセスしてAPIキーを取得してください。",

  // Provider dialog translations
  "dialog.provider.group.recommended": "おすすめ",
  "dialog.provider.strata.note": "500以上のAIモデルにアクセス",
