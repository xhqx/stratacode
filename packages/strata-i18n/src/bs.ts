export const dict = {
  ...
  "provider.connect.strataGateway.line1":
    "Strata Gateway omogućava pristup pažljivo odabranom skupu pouzdanih modela optimizovanih za rad sa agentima za kodiranje.",
  ...
  "provider.connect.strataGateway.visit.prefix": "Posjetite ",
  "provider.connect.strataGateway.visit.link": "strata.ai",
  "provider.connect.strataGateway.visit.suffix": " da preuzmete svoj API ključ.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Preporučeno",
  "dialog.provider.strata.note": "Pristup za 500+ AI modela",
