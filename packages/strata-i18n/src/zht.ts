export const dict = {
  ...
  "provider.connect.strataGateway.line1": "Strata Gateway 為您提供一組精選的可靠優化模型，專為編碼代理設計。",
  "provider.connect.strataGateway.line2": "只需一個 API 金鑰，您就可以使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.strataGateway.visit.prefix": "訪問 ",
  "provider.connect.strataGateway.visit.link": "strata.ai",
  "provider.connect.strataGateway.visit.suffix": " 獲取您的 API 金鑰。",

  // Provider dialog translations
  "dialog.provider.group.recommended": "推薦",
  "dialog.provider.strata.note": "存取 500+ AI 模型",
