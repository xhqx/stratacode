export const dict = {
  ...
  "provider.connect.strataGateway.line1":
    "Strata Gateway ให้คุณเข้าถึงชุดโมเดลที่คัดสรรมาอย่างดีและเชื่อถือได้สำหรับตัวแทนเขียนโค้ด",
  "provider.connect.strataGateway.line2":
    "ด้วย API key เดียว คุณจะสามารถเข้าถึงโมเดลต่างๆ เช่น Claude, GPT, Gemini, GLM และอื่นๆ",
  "provider.connect.strataGateway.visit.prefix": "เยี่ยมชม ",
  "provider.connect.strataGateway.visit.link": "strata.ai",
  "provider.connect.strataGateway.visit.suffix": " เพื่อรับ API key ของคุณ",

  // Provider dialog translations
  "dialog.provider.group.recommended": "แนะนำ",
  "dialog.provider.strata.note": "เข้าถึงโมเดล AI มากกว่า 500 รายการ",
