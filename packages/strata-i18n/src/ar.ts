export const dict = {
  ...
  "provider.connect.strataGateway.line1":
    "يمنحك Strata Gateway الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسّنة لوكلاء البرمجة.",
  ...
  "provider.connect.strataGateway.visit.prefix": "قم بزيارة ",
  "provider.connect.strataGateway.visit.link": "strata.ai",
  "provider.connect.strataGateway.visit.suffix": " للحصول على مفتاح API الخاص بك.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "موصى به",
  "dialog.provider.strata.note": "الوصول إلى أكثر من 500 نموذج ذكاء اصطناعي",
