export const dict = {
  ...
  "provider.connect.strataGateway.line1":
    "O Strata Gateway oferece acesso a um conjunto selecionado de modelos confiáveis e otimizados para agentes de codificação.",
  ...
  "provider.connect.strataGateway.visit.prefix": "Visite ",
  "provider.connect.strataGateway.visit.link": "strata.ai",
  "provider.connect.strataGateway.visit.suffix": " para obter sua chave de API.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Recomendados",
  "dialog.provider.strata.note": "Acesso a mais de 500 modelos de IA",
