...
export const dict = {
  ...
  "settings.providers.subtab.models": "LLM Providers",
  "settings.providers.subtab.acp": "ACP Connections",
  ...
  "settings.agentBehaviour.subtab.acpProviders": "ACP Providers",
  "settings.agentBehaviour.card.addAcp": "Add ACP provider",
  "settings.agentBehaviour.removeAcp.title": "Remove ACP provider?",
  "settings.agentBehaviour.removeAcp.confirm":
    "Are you sure you want to remove the '{{name}}' ACP provider configuration?",
  "settings.agentBehaviour.removeAcp.button": "Remove",

  "settings.agentBehaviour.acpBrowseMarketplace": "Browse Marketplace",
  "settings.agentBehaviour.acpEmpty": "No ACP providers configured. Add ACP providers in strata.jsonc.",
  ...
  "settings.agentBehaviour.editAcp.env.help": "Key-value pairs to pass to the provider process.",
  ...
  // Docs Hub keys
  "docs.title": "Document Hub",
  "docs.back": "Back",
  "docs.generating": "Generating...",
  "docs.generateAll": "Generate All Documentation",
  "docs.regenerate": "Regenerate this page",
  "docs.loadingManifest": "Loading manifest...",
  "docs.loadingPage": "Loading document...",
  "docs.noDocs": "No documentation found. Click 'Generate All' to create docs.",
  "docs.notFound": "Document not found or empty. Try regenerating.",
  "docs.pages": "Pages",
  "docs.backToIndex": "← Back to Index",
