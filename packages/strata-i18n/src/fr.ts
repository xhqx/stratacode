export const dict = {
  ...
  "provider.connect.strataGateway.line1":
    "Strata Gateway vous donne accès à une sélection de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.strataGateway.visit.prefix": "Visitez ",
  "provider.connect.strataGateway.visit.link": "strata.ai",
  "provider.connect.strataGateway.visit.suffix": " pour obtenir votre clé API.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Recommandés",
  "dialog.provider.strata.note": "Accès à plus de 500 modèles d'IA",
