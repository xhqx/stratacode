export const dict = {
  ...
  "provider.connect.strataGateway.line1":
    "Strata Gateway bietet Ihnen Zugang zu einer kuratierten Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.strataGateway.visit.prefix": "Besuchen Sie ",
  "provider.connect.strataGateway.visit.link": "strata.ai",
  "provider.connect.strataGateway.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Empfohlen",
  "dialog.provider.strata.note": "Zugriff auf 500+ KI-Modelle",
