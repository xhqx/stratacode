export const dict = {
  ...
  "provider.connect.strataGateway.line1":
    "Strata Gateway надає доступ до добірки надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.strataGateway.visit.prefix": "Відвідайте ",
  "provider.connect.strataGateway.visit.link": "strata.ai",
  "provider.connect.strataGateway.visit.suffix": " щоб отримати свій API-ключ.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Рекомендовані",
  "dialog.provider.strata.note": "Доступ до 500+ моделей ШІ",
