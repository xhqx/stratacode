export const dict = {
  ...
  "provider.connect.strataGateway.line1":
    "Strata Gateway te da acceso a un conjunto seleccionado de modelos optimizados y confiables para agentes de codificación.",
  "provider.connect.strataGateway.line2":
    "Con una sola clave API tendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.strataGateway.visit.prefix": "Visita ",
  "provider.connect.strataGateway.visit.link": "strata.ai",
  "provider.connect.strataGateway.visit.suffix": " para obtener tu clave API.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Recomendados",
  "dialog.provider.strata.note": "Acceso a más de 500 modelos de IA",
