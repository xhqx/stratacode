  ...
  new Hono()
    .post(
      ...
      describeRoute({
        ...
        operationId: "stratacode.sessionImport.project",
        responses: {
          200: {
    ...
    .post(
      ...
      describeRoute({
        ...
        operationId: "stratacode.sessionImport.session",
        responses: {
          200: {
    ...
    .post(
      ...
      describeRoute({
        ...
        operationId: "stratacode.sessionImport.message",
        responses: {
          200: {
    ...
    .post(
      ...
      describeRoute({
        ...
        operationId: "stratacode.sessionImport.part",
        responses: {
          200: {
