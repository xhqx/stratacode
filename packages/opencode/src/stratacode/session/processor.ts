...
export namespace StrataSessionProcessor {
  const log = Log.create({ service: "session.processor.strata" })
  ...
  /**
   * Returns the Strata-specific retry policy options (limit + offline handler).
