...
export namespace StrataCostPropagation {
  /**
   ...
   */
  export const childCost = Effect.fn("StrataCostPropagation.childCost")(function* (
   ...
   */
  export const propagate = Effect.fn("StrataCostPropagation.propagate")(function* (
    sessions: Session.Interface,
    sid: SessionID,
    mid: MessageID,
    amount: number,
