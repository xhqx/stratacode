...
const TABLE_PATH = root + "packages/strata-docs/markdoc/partials/cli-commands-table.md"
const REFERENCE_PATH = root + "packages/strata-docs/pages/code-with-ai/platforms/cli-reference.md"
...
// them here as well to keep strata.ai/docs in sync with the shipped binary.
