...
const TIPS = [
  ...
  "Strata can {highlight}configure itself{/highlight} if you ask it",
  "Ask Strata to {highlight}add Supabase MCP globally{/highlight}",
  "Ask Strata to {highlight}create a review agent for this project{/highlight}",
  "Ask Strata to {highlight}add a plugin for desktop alerts{/highlight}",
  "Ask Strata to {highlight}set Claude Sonnet as my default model{/highlight}",
  "Ask Strata to {highlight}make my review agent read-only{/highlight}",
  "Ask Strata to {highlight}require approval before git push{/highlight}",
  "Ask Strata to {highlight}turn off auto-formatting{/highlight}",
  "Ask Strata to {highlight}block access to .env files{/highlight}",
  "Ask Strata to {highlight}turn off the F2 shortcut{/highlight}",
  "Ask Strata to {highlight}match my terminal theme{/highlight}",
  "Ask Strata to {highlight}disable sharing for all sessions{/highlight}",
  "Ask Strata to {highlight}add rules from docs/ai-rules.md{/highlight}",
  "Ask Strata to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Ask Strata to {highlight}save this workflow as a /command{/highlight}",
  "Strata auto-handles OAuth for remote MCP servers requiring auth",
  "Strata auto-formats files using prettier, gofmt, ruff, and more",
  "Strata uses LSP servers for intelligent code analysis",
  "Use {highlight}strata run{/highlight} for non-interactive scripting",
  "Use {highlight}strata --continue{/highlight} to resume the last session",
  "Use {highlight}strata run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}strata serve{/highlight} for headless API access to Strata",
  "Use {highlight}strata run --attach{/highlight} to connect to a running server",
  "Run {highlight}strata upgrade{/highlight} to update to the latest version",
  "Run {highlight}strata auth list{/highlight} to see all configured providers",
