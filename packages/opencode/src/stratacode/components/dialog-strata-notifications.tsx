/**
 * Strata Notifications Dialog
 *
 * Displays all notifications from Strata API in a scrollable dialog.
...
interface DialogStrataNotificationsProps {
  notifications: StratacodeNotification[]
}

export function DialogStrataNotifications(props: DialogStrataNotificationsProps) {
