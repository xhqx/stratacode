...
import type { StratacodeProfile, StratacodeBalance } from "@stratacode/strata-gateway"

interface DialogStrataProfileProps {
  profile: StratacodeProfile
  balance: StratacodeBalance | null
  currentOrgId?: string | null
}

export function DialogStrataProfile(props: DialogStrataProfileProps) {
  ...
  const usageUrl = props.currentOrgId
    ? `https://app.strata.ai/organizations/${props.currentOrgId}/usage-details`
