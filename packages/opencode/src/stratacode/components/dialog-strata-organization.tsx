/**
 * Strata Gateway Organization Selection Dialog
 *
...
import { getOrganizationOptions, getDefaultOrganizationSelection } from "@stratacode/strata-gateway/tui"
...
interface DialogStrataOrganizationProps {
...
export function DialogStrataOrganization(props: DialogStrataOrganizationProps) {
