...
import z from "zod"
import { StrataSessionPromptQueue } from "../session/prompt-queue"
...
export namespace Suggestion {
  ...
  // stratacode_change - Instance.state() removed in v1.4.4; use module-level state
  ...
  export async function show(input: {
    ...
    if (StrataSessionPromptQueue.hasFollowup(SessionID.make(input.sessionID))) {
