...
const app = "strata" // stratacode_change
...
// which breaks every `strata` invocation at startup (including the SDK
...
export const Path = {
  // Allow override via STRATA_TEST_HOME for test isolation
  get home() {
    return (process.env.STRATA_TEST_HOME || os.homedir()).trim() // stratacode_change — defensive trim, see above
  },
  data,
