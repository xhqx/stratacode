...
} from "../../src/stratacode/indexing-feature"
...
describe("indexing plugin helpers", () => {
  ...
  test("does not add duplicate indexing plugin", () => {
    const list = ensureIndexingPlugin(["@stratacode/strata-indexing@1.0.0"], INDEXING_PLUGIN)
    expect(list).toEqual(["@stratacode/strata-indexing@1.0.0"])
  })
