...
import type { GitContext } from "@/stratacode/commit-message/types"
...
const realGitContext = await import("@/stratacode/commit-message/git-context")
...
mock.module("@/stratacode/commit-message/git-context", () => ({
  ...realGitContext,
...
import { generateCommitMessage } from "../../../src/stratacode/commit-message/generate"
