...
// stratacode integration in shared LSP files, these tests catch it.

import { describe, test, expect, spyOn, afterEach } from "bun:test"
import path from "path"
import { LSPServer } from "../../src/lsp"
import { TsClient } from "../../src/stratacode/ts-client"
import { TsCheck } from "../../src/stratacode/ts-check"
...
describe("typescript lightweight mode", () => {
  ...
  describe("source integration guards", () => {
    // These tests verify that stratacode integration code exists in shared
    ...
    test("lsp/server.ts gates Typescript.spawn behind flag", async () => {
      ...
      expect(src).toContain("STRATA_EXPERIMENTAL_LSP_TOOL")
