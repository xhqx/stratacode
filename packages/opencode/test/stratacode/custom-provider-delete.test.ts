...
//
// Regression tests for https://github.com/Strata-Org/stratacode/issues/9186
//
...
import { StratacodeConfig } from "../../src/stratacode/config/config"
...
describe("StratacodeConfig.mergeConfig — custom provider model/variant deletion", () => {
  it("drops a model from an existing provider when the patch sets it to null", () => {
    ...
    const merged = StratacodeConfig.mergeConfig(existing, patch)
