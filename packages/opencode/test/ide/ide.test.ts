...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders STRATA_CALLER", () => {
    process.env["STRATA_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode STRATA_CALLER", () => {
    process.env["STRATA_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown STRATA_CALLER", () => {
    process.env["STRATA_CALLER"] = "unknown"
