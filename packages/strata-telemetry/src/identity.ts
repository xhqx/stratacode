...
import { fetchProfile } from "@stratacode/strata-gateway"
...
export namespace Identity {
  ...
  export async function getMachineId(): Promise<string | undefined> {
    ...
    const override = process.env.STRATA_MACHINE_ID
    if (override) {
      machineId = override
      return machineId
    }
  ...
  export async function updateFromStrataAuth(token: string | null, accountId?: string): Promise<void> {
