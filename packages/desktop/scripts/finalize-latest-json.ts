...
const releaseId = process.env.STRATA_RELEASE
if (!releaseId) throw new Error("STRATA_RELEASE is required")

const version = process.env.STRATA_VERSION
if (!version) throw new Error("STRATA_VERSION is required")
