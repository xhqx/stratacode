export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Strata",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Strata er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "Strata Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Strata CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
