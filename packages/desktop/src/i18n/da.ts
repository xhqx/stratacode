export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Strata",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Strata er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.error.sidecarMissing": "Strata CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
