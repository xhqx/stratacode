export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Strata",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Strata wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.menu.help.documentation": "Strata-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "Das Strata CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
