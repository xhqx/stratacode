export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Strata",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Strata، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق Strata",
  ...
  "desktop.cli.error.sidecarMissing": "ملف Strata CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
