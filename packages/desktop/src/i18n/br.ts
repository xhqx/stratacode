export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Strata",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Strata foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do Strata",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do Strata está ausente. Tente reinstalar o aplicativo de desktop.",
