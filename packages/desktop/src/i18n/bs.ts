export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Strata-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Strata-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.menu.help.documentation": "Strata Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka Strata CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
