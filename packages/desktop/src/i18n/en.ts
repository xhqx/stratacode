export const dict = {
  ...
  "desktop.menu.help.documentation": "Strata Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of Strata",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Strata has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.error.sidecarMissing": "Strata CLI binary is missing. Try reinstalling the desktop app.",
