export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Strata",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Strata. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.menu.help.documentation": "Dokumentacja Strata",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego Strata CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
