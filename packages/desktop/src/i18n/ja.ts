export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Strata を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Strata のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.menu.help.documentation": "Strata ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "Strata CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
