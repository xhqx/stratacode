export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Strata",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Strata. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de Strata",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de Strata. Intenta reinstalar la aplicación de escritorio.",
