export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Strata",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Strata a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.menu.help.documentation": "Documentation d'Strata",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI Strata est manquant. Essayez de réinstaller l'application de bureau.",
