...
// stratacode_change start - Preferred providers list (order determines display priority)
export const popularProviders = ["strata", "anthropic", "github-copilot", "openai", "google", "openrouter", "vercel"]
