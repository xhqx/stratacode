export const dict = {
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Strata dans WSL sur Windows.",
  ...
  "settings.general.row.colorScheme.description": "Choisissez si Strata suit le thème système, clair ou sombre",
