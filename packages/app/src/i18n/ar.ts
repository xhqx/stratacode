export const dict = {
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Strata داخل WSL على Windows.",
  ...
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Strata يتبع سمة النظام أو الفاتح أو الداكن",
