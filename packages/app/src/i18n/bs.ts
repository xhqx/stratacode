export const dict = {
  ...
  "settings.desktop.wsl.description": "Pokreni Strata server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.colorScheme.description": "Odaberi da li Strata prati sistemsku, svijetlu ili tamnu temu",
