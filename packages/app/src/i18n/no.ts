...
export const dict = {
  ...
  "settings.desktop.wsl.description": "Kjør Strata-serveren i WSL på Windows.",
  ...
  "settings.general.row.colorScheme.description": "Velg om Strata skal følge systemets, lyst eller mørkt tema",
