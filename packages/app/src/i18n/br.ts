export const dict = {
  ...
  "settings.desktop.wsl.description": "Executar o servidor Strata dentro do WSL no Windows.",
  ...
  "settings.general.row.colorScheme.description": "Escolha se o Strata segue o tema do sistema, claro ou escuro",
