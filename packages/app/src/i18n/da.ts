export const dict = {
  ...
  "settings.desktop.wsl.description": "Kør Strata-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.colorScheme.description": "Vælg om Strata følger systemets, lyst eller mørkt tema",
