export const dict = {
  ...
  "settings.desktop.wsl.description": "Запускать сервер Strata внутри WSL на Windows.",
  ...
  "settings.general.row.colorScheme.description": "Выберите, следует ли Strata системной, светлой или тёмной теме",
