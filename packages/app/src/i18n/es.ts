export const dict = {
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Strata dentro de WSL en Windows.",
  ...
  "settings.general.row.colorScheme.description": "Elige si Strata sigue el tema del sistema, claro u oscuro",
