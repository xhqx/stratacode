export const dict = {
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Strata ภายใน WSL บน Windows",
  ...
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Strata ใช้ธีมตามระบบ สว่าง หรือมืด",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Strata เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Strata เวอร์ชันล่าสุด",
