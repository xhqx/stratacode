...
export const dict = {
  ...
  "settings.desktop.wsl.description": "Strata-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.colorScheme.description": "Wählen Sie, ob Strata dem System-, hellen oder dunklen Thema folgt",
