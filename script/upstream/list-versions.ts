...
import { getAvailableUpstreamVersions, getCurrentStrataVersion } from "./utils/version"
...
async function main() {
  ...
  const strataVersion = await getCurrentStrataVersion()

  console.log()
  success(`Current Strata version: ${strataVersion}`)
  console.log()
