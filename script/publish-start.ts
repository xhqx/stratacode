...
const skipNotes = process.env["STRATA_SKIP_NOTES"] === "1" // stratacode_change
if (skipNotes) console.log("changelog skipped: STRATA_SKIP_NOTES=1") // stratacode_change
...
if (!Script.preview) {
  ...
  // stratacode_change start - skip draft flag when STRATA_SKIP_NOTES=1 (used by publish-stable.yml which doesn't have a publish-complete step)
