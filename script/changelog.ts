...
Generates UPCOMING_CHANGELOG.md by running the strata changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for strata run (default: low)
      --quiet            Suppress strata command output unless it fails
...
const cmd = ["strata", "run"] // stratacode_change - opencode -> strata
