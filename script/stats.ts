...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/Strata-Org/stratacode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for Strata-Org/stratacode...\n")
